...
const config = {
  theme: {
    ...
    extend: {
      ...
      boxShadow: {
        'xs': '0px 1px 3px rgba(139, 92, 246, 0.04), 0px 1px 2px rgba(16, 24, 40, 0.03)',
        'sm': '0px 2px 8px rgba(139, 92, 246, 0.06), 0px 1px 3px rgba(16, 24, 40, 0.04)',
        'sm-no-bottom': '0px -2px 8px rgba(139, 92, 246, 0.06), 0px -1px 3px rgba(16, 24, 40, 0.04)',
        'md': '0px 4px 16px -2px rgba(139, 92, 246, 0.08), 0px 2px 6px rgba(16, 24, 40, 0.04)',
        'lg': '0px 8px 28px -4px rgba(139, 92, 246, 0.10), 0px 4px 12px rgba(16, 24, 40, 0.04)',
        'xl': '0px 16px 44px -8px rgba(139, 92, 246, 0.12), 0px 8px 16px rgba(16, 24, 40, 0.04)',
        '2xl': '0px 24px 56px -12px rgba(139, 92, 246, 0.16)',
        '3xl': '0px 32px 72px -12px rgba(139, 92, 246, 0.14)',
