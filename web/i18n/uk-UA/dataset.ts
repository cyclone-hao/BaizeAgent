const translation = {
  ...
  intro1: 'Знання можна інтегрувати до програми 白泽智能体平台 ',
  intro2: 'як контекст',
  intro3: ',',
  intro4: 'або його ',
  ...
  externalAPIPanelDescription: 'API зовнішніх знань використовується для підключення до бази знань за межами 白泽智能体平台 і отримання знань із цієї бази знань.',
  chunkingMode: {
