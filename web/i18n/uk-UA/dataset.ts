const translation = {
  ...
  intro1: 'Знання можна інтегрувати до програми AgentFlow ',
  intro2: 'як контекст',
  intro3: ',',
  intro4: 'або його ',
  ...
  externalAPIPanelDescription: 'API зовнішніх знань використовується для підключення до бази знань за межами AgentFlow і отримання знань із цієї бази знань.',
  chunkingMode: {
