const translation = {
  ...
  account: {
    ...
    langGeniusAccount: 'Обліковий запис 白泽智能体平台',
    langGeniusAccountTip: 'Ваш обліковий запис 白泽智能体平台 та пов’язані з ним дані користувача.',
  ...
  members: {
    ...
    invitationSentTip: 'Запрошення надіслано, і вони можуть увійти в 白泽智能体平台, щоб отримати доступ до даних вашої команди.',
  ...
  provider: {
    ...
    openaiHosted: {
      ...
      desc: 'Служба хостингу OpenAI, надана 白泽智能体平台, дозволяє використовувати такі моделі, як GPT-3.5. Перш ніж ваша пробна квота буде використана, вам потрібно налаштувати інші постачальники моделі.',
  ...
  apiBasedExtension: {
    title: 'API-розширення забезпечують централізоване керування API, спрощуючи конфігурацію для зручного використання в різних програмах 白泽智能体平台.',
  ...
  about: {
    ...
    nowAvailable: '白泽智能体平台 {{version}} тепер доступна.',
    latestAvailable: '白泽智能体平台 {{version}} – це найновіша доступна версія.',
  },
  appMenus: {
    overview: 'Моніторинг',
