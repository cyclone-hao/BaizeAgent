const translation = {
  ...
  account: {
    ...
    langGeniusAccount: 'Обліковий запис AgentFlow',
    langGeniusAccountTip: 'Ваш обліковий запис AgentFlow та пов’язані з ним дані користувача.',
  ...
  members: {
    ...
    invitationSentTip: 'Запрошення надіслано, і вони можуть увійти в AgentFlow, щоб отримати доступ до даних вашої команди.',
  ...
  provider: {
    ...
    openaiHosted: {
      ...
      desc: 'Служба хостингу OpenAI, надана AgentFlow, дозволяє використовувати такі моделі, як GPT-3.5. Перш ніж ваша пробна квота буде використана, вам потрібно налаштувати інші постачальники моделі.',
  ...
  apiBasedExtension: {
    title: 'API-розширення забезпечують централізоване керування API, спрощуючи конфігурацію для зручного використання в різних програмах AgentFlow.',
  ...
  about: {
    ...
    nowAvailable: 'AgentFlow {{version}} тепер доступна.',
    latestAvailable: 'AgentFlow {{version}} – це найновіша доступна версія.',
  },
  appMenus: {
    overview: 'Моніторинг',
