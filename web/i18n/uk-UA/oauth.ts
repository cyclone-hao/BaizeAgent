const translation = {
  tips: {
    notLoggedIn: 'Цей додаток хоче отримати доступ до вашого облікового запису AgentFlow Cloud',
    needLogin: 'Будь ласка, увійдіть, щоб авторизуватися.',
    loggedIn: 'Цей додаток хоче отримати доступ до наступної інформації з вашого облікового запису AgentFlow Cloud.',
