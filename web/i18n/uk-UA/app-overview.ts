const translation = {
  ...
  apiKeyInfo: {
    ...
    tryCloud: 'Або спробуйте хмарну версію 白泽智能体平台 з безкоштовним цитатою',
  },
  overview: {
    title: 'Огляд',
    appInfo: {
      ...
      settings: {
        ...
        more: {
          ...
          privacyPolicyTip: 'Допомагає відвідувачам зрозуміти дані, зібрані додатком, див. <privacyPolicyLink>Політику конфіденційності</privacyPolicyLink> 白泽智能体平台.',
      ...
      embedded: {
        ...
        chromePlugin: 'Встановити розширення Chrome 白泽智能体平台 Chatbot',
        copied: 'Скопійовано',
        copy: 'Скопіювати',
      },
      qrcode: {
      ...
      customize: {
        ...
        way1: {
          ...
          step1Operation: 'Клієнт-Web-白泽智能体平台',
