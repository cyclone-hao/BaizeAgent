const translation = {
  ...
  apiKeyInfo: {
    ...
    tryCloud: 'Або спробуйте хмарну версію AgentFlow з безкоштовним цитатою',
  },
  overview: {
    title: 'Огляд',
    appInfo: {
      ...
      settings: {
        ...
        more: {
          ...
          privacyPolicyTip: 'Допомагає відвідувачам зрозуміти дані, зібрані додатком, див. <privacyPolicyLink>Політику конфіденційності</privacyPolicyLink> AgentFlow.',
      ...
      embedded: {
        ...
        chromePlugin: 'Встановити розширення Chrome AgentFlow Chatbot',
        copied: 'Скопійовано',
        copy: 'Скопіювати',
      },
      qrcode: {
      ...
      customize: {
        ...
        way1: {
          ...
          step1Operation: 'Клієнт-Web-AgentFlow',
