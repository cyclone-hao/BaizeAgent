const translation = {
  ...
  tracing: {
    ...
    aliyun: {
      ...
      description: 'Повністю керовані та без обслуговування платформи спостереження, надані Alibaba Cloud, дозволяють миттєвий моніторинг, трасування та оцінку застосувань 白泽智能体平台.',
    },
  },
  answerIcon: {
