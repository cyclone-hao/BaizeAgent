const translation = {
  ...
  otherDataSource: {
    ...
    description: 'Наразі база знань 白泽智能体平台 має лише обмежені джерела даних. Додавання джерела даних до бази знань 白泽智能体平台 – це фантастичний спосіб підвищити гнучкість і потужність платформи для всіх користувачів. Наш посібник із внеску спрощує початок роботи. Будь ласка, натисніть на посилання нижче, щоб дізнатися більше.',
  },
  watercrawl: {
