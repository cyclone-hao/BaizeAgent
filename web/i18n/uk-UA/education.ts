const translation = {
  toVerifiedTip: {
    end: 'для професійного плану AgentFlow.',
  ...
  form: {
    ...
    terms: {
      ...
      option: {
        inSchool: 'Я підтверджую, що я зареєстрований або працюю в зазначеній установі. AgentFlow може вимагати підтвердження моєї реєстрації/трудової зайнятості. Якщо я неправильно представлю свою кваліфікацію, я погоджуюся сплатити будь-які збори, які спочатку були скасовані на основі мого навчального статусу.',
  ...
  rejectTitle: 'Ваша перевірка освіти AgentFlow була відхилена',
  submit: 'Надіслати',
  successTitle: 'Ви отримали перевірене освіту AgentFlow',
  emailLabel: 'Ваш поточний електронний лист',
  rejectContent: 'На жаль, ви не відповідаєте вимогам для статусу Education Verified і тому не можете отримати ексклюзивний купон на 100% для професійного плану AgentFlow, якщо використовуєте цю електронну адресу.',
  ...
  successContent: 'Ми видали купон на 100% знижку на професійний план AgentFlow для вашого акаунту. Купон дійсний протягом одного року, будь ласка, скористайтеся ним протягом терміну дії.',
  notice: {
    expired: {
      summary: {
        line2: 'Однак ви більше не маєте права на нові купони на знижку на освіту.',
        line1: 'Ви все ще можете отримати доступ до AgentFlow і використовувати його.',
      },
