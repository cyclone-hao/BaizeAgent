const translation = {
  toVerifiedTip: {
    end: 'для професійного плану 白泽智能体平台.',
  ...
  form: {
    ...
    terms: {
      ...
      option: {
        inSchool: 'Я підтверджую, що я зареєстрований або працюю в зазначеній установі. 白泽智能体平台 може вимагати підтвердження моєї реєстрації/трудової зайнятості. Якщо я неправильно представлю свою кваліфікацію, я погоджуюся сплатити будь-які збори, які спочатку були скасовані на основі мого навчального статусу.',
  ...
  rejectTitle: 'Ваша перевірка освіти 白泽智能体平台 була відхилена',
  submit: 'Надіслати',
  successTitle: 'Ви отримали перевірене освіту 白泽智能体平台',
  emailLabel: 'Ваш поточний електронний лист',
  rejectContent: 'На жаль, ви не відповідаєте вимогам для статусу Education Verified і тому не можете отримати ексклюзивний купон на 100% для професійного плану 白泽智能体平台, якщо використовуєте цю електронну адресу.',
  ...
  successContent: 'Ми видали купон на 100% знижку на професійний план 白泽智能体平台 для вашого акаунту. Купон дійсний протягом одного року, будь ласка, скористайтеся ним протягом терміну дії.',
  notice: {
    expired: {
      summary: {
        line2: 'Однак ви більше не маєте права на нові купони на знижку на освіту.',
        line1: 'Ви все ще можете отримати доступ до 白泽智能体平台 і використовувати його.',
      },
