const translation = {
  list: {
    title: 'Документи',
    desc: 'Тут відображаються всі файли Знання, і все Знання можна зв’язати з цитатами 白泽智能体平台 або проіндексувати за допомогою плагіна Chat.',
    addFile: 'додати файл',
    ...
    empty: {
      ...
      sync: {
        tip: '白泽智能体平台 періодично завантажуватиме файли з вашого Notion і завершуватиме обробку.',
      },
    },
    delete: {
