const translation = {
  list: {
    title: 'Документи',
    desc: 'Тут відображаються всі файли Знання, і все Знання можна зв’язати з цитатами AgentFlow або проіндексувати за допомогою плагіна Chat.',
    addFile: 'додати файл',
    ...
    empty: {
      ...
      sync: {
        tip: 'AgentFlow періодично завантажуватиме файли з вашого Notion і завершуватиме обробку.',
      },
    },
    delete: {
