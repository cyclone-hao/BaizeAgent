const translation = {
  ...
  form: {
    ...
    descPlaceholder: 'Опишіть, що міститься в цій базі знань. Детальний опис дозволяє AI своєчасно отримати доступ до вмісту бази знань. Якщо значення порожнє, AgentFlow використовуватиме стратегію влучань за умовчанням.',
