const translation = {
  ...
  plansCommon: {
    ...
    ragAPIRequestTooltip: 'Відноситься до кількості викликів API, що викликають лише можливості обробки бази знань AgentFlow.',
    ...
    apiRateLimitTooltip: 'Обмеження частоти запитів застосовується до всіх запитів, зроблених через API AgentFlow, включаючи генерацію тексту, чат-розмови, виконання робочих процесів та обробку документів.',
  ...
  plans: {
    ...
    enterprise: {
      ...
      features: {
        ...
        5: 'Угода про рівень обслуговування за домовленістю від AgentFlow Partners',
        3: 'Кілька робочих областей і управління підприємством',
        0: 'Масштабовані рішення для розгортання корпоративного рівня',
        7: 'Оновлення та обслуговування від AgentFlow Official',
      },
    ...
    community: {
      features: {
        ...
        2: 'Відповідає ліцензії AgentFlow з відкритим вихідним кодом',
