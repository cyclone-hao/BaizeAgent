const translation = {
  ...
  plansCommon: {
    ...
    ragAPIRequestTooltip: 'Відноситься до кількості викликів API, що викликають лише можливості обробки бази знань 白泽智能体平台.',
    ...
    apiRateLimitTooltip: 'Обмеження частоти запитів застосовується до всіх запитів, зроблених через API 白泽智能体平台, включаючи генерацію тексту, чат-розмови, виконання робочих процесів та обробку документів.',
  ...
  plans: {
    ...
    enterprise: {
      ...
      features: {
        ...
        5: 'Угода про рівень обслуговування за домовленістю від 白泽智能体平台 Partners',
        3: 'Кілька робочих областей і управління підприємством',
        0: 'Масштабовані рішення для розгортання корпоративного рівня',
        7: 'Оновлення та обслуговування від 白泽智能体平台 Official',
      },
    ...
    community: {
      features: {
        ...
        2: 'Відповідає ліцензії 白泽智能体平台 з відкритим вихідним кодом',
