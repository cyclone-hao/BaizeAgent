const translation = {
  ...
  welcome: 'Ласкаво просимо до 白泽智能体平台, будь ласка, увійдіть, щоб продовжити.',
  ...
  license: {
    tip: 'Перед запуском 白泽智能体平台 Community Edition ознайомтеся з ліцензією з відкритим кодом на GitHub',
    link: 'Ліцензія з відкритим кодом',
  },
  join: 'Приєднуйтесь',
  joinTipStart: 'Запрошуємо вас приєднатися',
  joinTipEnd: 'команда 白泽智能体平台',
  invalid: 'Посилання застаріло',
  explore: 'Досліджуйте 白泽智能体平台',
  ...
  resetPasswordDesc: 'Введіть адресу електронної пошти, яку ви використовували для реєстрації на 白泽智能体平台, і ми надішлемо вам електронний лист для скидання пароля.',
  resetPassword: 'Скинути пароль',
  licenseLostTip: 'Не вдалося підключити сервер ліцензій 白泽智能体平台. Будь ласка, зверніться до свого адміністратора, щоб продовжити користуватися 白泽智能体平台.',
  licenseExpired: 'Термін дії ліцензії минув',
  licenseInactive: 'Ліцензія неактивна',
  licenseLost: 'Ліцензію втрачено',
  licenseInactiveTip: 'Ліцензія 白泽智能体平台 Enterprise для вашої робочої області неактивна. Будь ласка, зверніться до свого адміністратора, щоб продовжити користуватися 白泽智能体平台.',
  licenseExpiredTip: 'Термін дії ліцензії 白泽智能体平台 Enterprise для вашого робочого простору закінчився. Будь ласка, зверніться до свого адміністратора, щоб продовжити користуватися 白泽智能体平台.',
  webapp: {
