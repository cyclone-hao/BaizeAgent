const translation = {
  ...
  welcome: 'Ласкаво просимо до AgentFlow, будь ласка, увійдіть, щоб продовжити.',
  ...
  license: {
    tip: 'Перед запуском AgentFlow Community Edition ознайомтеся з ліцензією з відкритим кодом на GitHub',
    link: 'Ліцензія з відкритим кодом',
  },
  join: 'Приєднуйтесь',
  joinTipStart: 'Запрошуємо вас приєднатися',
  joinTipEnd: 'команда AgentFlow',
  invalid: 'Посилання застаріло',
  explore: 'Досліджуйте AgentFlow',
  ...
  resetPasswordDesc: 'Введіть адресу електронної пошти, яку ви використовували для реєстрації на AgentFlow, і ми надішлемо вам електронний лист для скидання пароля.',
  resetPassword: 'Скинути пароль',
  licenseLostTip: 'Не вдалося підключити сервер ліцензій AgentFlow. Будь ласка, зверніться до свого адміністратора, щоб продовжити користуватися AgentFlow.',
  licenseExpired: 'Термін дії ліцензії минув',
  licenseInactive: 'Ліцензія неактивна',
  licenseLost: 'Ліцензію втрачено',
  licenseInactiveTip: 'Ліцензія AgentFlow Enterprise для вашої робочої області неактивна. Будь ласка, зверніться до свого адміністратора, щоб продовжити користуватися AgentFlow.',
  licenseExpiredTip: 'Термін дії ліцензії AgentFlow Enterprise для вашого робочого простору закінчився. Будь ласка, зверніться до свого адміністратора, щоб продовжити користуватися AgentFlow.',
  webapp: {
