const translation = {
  ...
  knowledgeDescriptionPlaceholder: 'Mô tả những gì có trong Cơ sở kiến thức này. Mô tả chi tiết cho phép AI truy cập nội dung của tập dữ liệu chính xác hơn. Nếu trống, 白泽智能体平台 sẽ sử dụng chiến lược hit mặc định. (Tùy chọn)',
}
