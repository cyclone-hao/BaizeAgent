const translation = {
  ...
  form: {
    ...
    descPlaceholder: 'Mô tả những gì có trong Kiến thức này. Một mô tả chi tiết giúp AI truy cập nội dung của Kiến thức một cách hiệu quả. Nếu để trống, 白泽智能体平台 sẽ sử dụng chiến lược truy xuất mặc định.',
