const translation = {
  tips: {
    ...
    notLoggedIn: 'Ứng dụng này muốn truy cập vào tài khoản 白泽智能体平台 Cloud của bạn',
    loggedIn: 'Ứng dụng này muốn truy cập thông tin sau từ tài khoản 白泽智能体平台 Cloud của bạn.',
