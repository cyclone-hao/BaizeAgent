const translation = {
  tips: {
    ...
    notLoggedIn: 'Ứng dụng này muốn truy cập vào tài khoản AgentFlow Cloud của bạn',
    loggedIn: 'Ứng dụng này muốn truy cập thông tin sau từ tài khoản AgentFlow Cloud của bạn.',
