const translation = {
  ...
  welcome: 'Chào mừng bạn đến với AgentFlow, vui lòng đăng nhập để tiếp tục.',
  email: 'Địa chỉ email',
  ...
  license: {
    tip: 'Trước khi bắt đầu sử dụng Phiên bản Cộng đồng của AgentFlow, vui lòng đọc',
    link: 'Giấy phép mã nguồn mở trên GitHub',
  },
  join: 'Tham gia',
  joinTipStart: 'Mời bạn tham gia',
  joinTipEnd: 'đội ngũ tại AgentFlow',
  invalid: 'Liên kết đã hết hạn',
  explore: 'Khám phá AgentFlow',
  ...
  or: 'HOẶC',
  resetPasswordDesc: 'Nhập email bạn đã sử dụng để đăng ký trên AgentFlow và chúng tôi sẽ gửi cho bạn email đặt lại mật khẩu.',
  ...
  licenseInactiveTip: 'Giấy phép AgentFlow Enterprise cho không gian làm việc của bạn không hoạt động. Vui lòng liên hệ với quản trị viên của bạn để tiếp tục sử dụng AgentFlow.',
  licenseExpired: 'Giấy phép đã hết hạn',
  licenseExpiredTip: 'Giấy phép AgentFlow Enterprise cho không gian làm việc của bạn đã hết hạn. Vui lòng liên hệ với quản trị viên của bạn để tiếp tục sử dụng AgentFlow.',
  licenseLostTip: 'Không thể kết nối máy chủ cấp phép AgentFlow. Vui lòng liên hệ với quản trị viên của bạn để tiếp tục sử dụng AgentFlow.',
  webapp: {
