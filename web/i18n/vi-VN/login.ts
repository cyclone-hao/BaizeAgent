const translation = {
  ...
  welcome: 'Chào mừng bạn đến với 白泽智能体平台, vui lòng đăng nhập để tiếp tục.',
  email: 'Địa chỉ email',
  ...
  license: {
    tip: 'Trước khi bắt đầu sử dụng Phiên bản Cộng đồng của 白泽智能体平台, vui lòng đọc',
    link: 'Giấy phép mã nguồn mở trên GitHub',
  },
  join: 'Tham gia',
  joinTipStart: 'Mời bạn tham gia',
  joinTipEnd: 'đội ngũ tại 白泽智能体平台',
  invalid: 'Liên kết đã hết hạn',
  explore: 'Khám phá 白泽智能体平台',
  ...
  or: 'HOẶC',
  resetPasswordDesc: 'Nhập email bạn đã sử dụng để đăng ký trên 白泽智能体平台 và chúng tôi sẽ gửi cho bạn email đặt lại mật khẩu.',
  ...
  licenseInactiveTip: 'Giấy phép 白泽智能体平台 Enterprise cho không gian làm việc của bạn không hoạt động. Vui lòng liên hệ với quản trị viên của bạn để tiếp tục sử dụng 白泽智能体平台.',
  licenseExpired: 'Giấy phép đã hết hạn',
  licenseExpiredTip: 'Giấy phép 白泽智能体平台 Enterprise cho không gian làm việc của bạn đã hết hạn. Vui lòng liên hệ với quản trị viên của bạn để tiếp tục sử dụng 白泽智能体平台.',
  licenseLostTip: 'Không thể kết nối máy chủ cấp phép 白泽智能体平台. Vui lòng liên hệ với quản trị viên của bạn để tiếp tục sử dụng 白泽智能体平台.',
  webapp: {
