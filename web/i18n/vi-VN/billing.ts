const translation = {
  ...
  plansCommon: {
    ...
    ragAPIRequestTooltip: 'Đề cập đến số lượng cuộc gọi API triệu hồi chỉ khả năng xử lý cơ sở kiến thức của AgentFlow.',
    ...
    apiRateLimitTooltip: 'Giới hạn tần suất API áp dụng cho tất cả các yêu cầu được thực hiện thông qua API AgentFlow, bao gồm tạo văn bản, cuộc trò chuyện, thực thi quy trình làm việc và xử lý tài liệu.',
  ...
  plans: {
    ...
    enterprise: {
      ...
      features: {
        ...
        5: 'SLA được đàm phán bởi AgentFlow Partners',
        0: 'Giải pháp triển khai có thể mở rộng cấp doanh nghiệp',
        7: 'Cập nhật và bảo trì bởi AgentFlow chính thức',
