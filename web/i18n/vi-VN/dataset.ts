const translation = {
  ...
  intro1: 'Bộ kiến thức có thể được tích hợp vào ứng dụng 白泽智能体平台 ',
  ...
  externalAPIPanelDescription: 'API kiến thức bên ngoài được sử dụng để kết nối với cơ sở kiến thức bên ngoài 白泽智能体平台 và truy xuất kiến thức từ cơ sở kiến thức đó.',
  chunkingMode: {
    general: 'Tổng quát',
