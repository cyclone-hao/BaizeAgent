const translation = {
  ...
  apiKeyInfo: {
    ...
    tryCloud: 'O prueba la versión en la nube de AgentFlow con una cotización gratuita',
  },
  overview: {
    title: 'Resumen',
    appInfo: {
      ...
      settings: {
        ...
        more: {
          ...
          privacyPolicyTip: 'Ayuda a los visitantes a comprender los datos que recopila la aplicación, consulta la <privacyPolicyLink>Política de privacidad</privacyPolicyLink> de AgentFlow.',
      ...
      embedded: {
        ...
        chromePlugin: 'Instalar la extensión de Chrome de AgentFlow Chatbot',
        copied: 'Copiado',
        copy: 'Copiar',
      },
      qrcode: {
