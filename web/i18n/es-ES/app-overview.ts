const translation = {
  ...
  apiKeyInfo: {
    ...
    tryCloud: 'O prueba la versión en la nube de 白泽智能体平台 con una cotización gratuita',
  },
  overview: {
    title: 'Resumen',
    appInfo: {
      ...
      settings: {
        ...
        more: {
          ...
          privacyPolicyTip: 'Ayuda a los visitantes a comprender los datos que recopila la aplicación, consulta la <privacyPolicyLink>Política de privacidad</privacyPolicyLink> de 白泽智能体平台.',
      ...
      embedded: {
        ...
        chromePlugin: 'Instalar la extensión de Chrome de 白泽智能体平台 Chatbot',
        copied: 'Copiado',
        copy: 'Copiar',
      },
      qrcode: {
