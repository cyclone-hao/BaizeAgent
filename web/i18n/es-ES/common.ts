const translation = {
  ...
  account: {
    ...
    langGeniusAccount: 'Cuenta 白泽智能体平台',
    langGeniusAccountTip: 'Tu cuenta 白泽智能体平台 y los datos de usuario asociados.',
  ...
  members: {
    ...
    invitationSentTip: 'Invitación enviada, y pueden iniciar sesión en 白泽智能体平台 para acceder a tus datos del equipo.',
  ...
  provider: {
    ...
    openaiHosted: {
      ...
      desc: 'El servicio de hospedaje OpenAI proporcionado por 白泽智能体平台 te permite usar modelos como GPT-3.5. Antes de que se agote tu cuota de prueba, necesitas configurar otros proveedores de modelos.',
  ...
  apiBasedExtension: {
    title: 'Las extensiones basadas en API proporcionan una gestión centralizada de API, simplificando la configuración para su fácil uso en las aplicaciones de 白泽智能体平台.',
  ...
  about: {
    ...
    nowAvailable: '白泽智能体平台 {{version}} ya está disponible.',
    latestAvailable: '白泽智能体平台 {{version}} es la última versión disponible.',
  },
  appMenus: {
    overview: 'Monitoreo',
    promptEng: 'Orquestar',
