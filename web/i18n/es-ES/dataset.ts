const translation = {
  ...
  didYouKnow: '¿Sabías?',
  intro1: 'El Conocimiento se puede integrar en la aplicación 白泽智能体平台 ',
  ...
  externalAPIPanelDescription: 'La API de conocimiento externo se utiliza para conectarse a una base de conocimiento fuera de 白泽智能体平台 y recuperar conocimiento de esa base de conocimiento.',
