const translation = {
  ...
  plansCommon: {
    ...
    ragAPIRequestTooltip: 'Se refiere al número de llamadas API que invocan solo las capacidades de procesamiento de base de conocimientos de 白泽智能体平台.',
    ...
    apiRateLimitTooltip: 'El límite de tasa de la API se aplica a todas las solicitudes realizadas a través de la API de 白泽智能体平台, incluidos la generación de texto, las conversaciones de chat, las ejecuciones de flujo de trabajo y el procesamiento de documentos.',
  ...
  plans: {
    ...
    enterprise: {
      ...
      features: [
        ...
        'SLAs negociados con socios de 白泽智能体平台',
        'Seguridad y controles avanzados',
        'Actualizaciones y mantenimiento oficiales por parte de 白泽智能体平台',
    ...
    community: {
      ...
      features: [
        ...
        'Cumple con la licencia de código abierto de 白泽智能体平台',
      ],
    },
    premium: {
