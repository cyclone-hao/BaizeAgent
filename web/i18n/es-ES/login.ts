const translation = {
  ...
  welcome: 'Bienvenido a 白泽智能体平台, por favor inicia sesión para continuar.',
  ...
  resetPasswordDesc: 'Escriba el correo electrónico que utilizó para registrarse en 白泽智能体平台 y le enviaremos un correo electrónico de restablecimiento de contraseña.',
  ...
  licenseInactiveTip: 'La licencia de 白泽智能体平台 Enterprise para su espacio de trabajo está inactiva. Póngase en contacto con su administrador para seguir utilizando 白泽智能体平台.',
  licenseExpired: 'Licencia caducada',
  licenseLost: 'Licencia perdida',
  licenseExpiredTip: 'La licencia de 白泽智能体平台 Enterprise para su espacio de trabajo ha caducado. Póngase en contacto con su administrador para seguir utilizando 白泽智能体平台.',
  licenseLostTip: 'No se pudo conectar el servidor de licencias de Dife. Póngase en contacto con su administrador para seguir utilizando 白泽智能体平台.',
  webapp: {
