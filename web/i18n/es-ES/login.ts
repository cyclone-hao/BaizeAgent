const translation = {
  ...
  welcome: 'Bienvenido a AgentFlow, por favor inicia sesión para continuar.',
  ...
  resetPasswordDesc: 'Escriba el correo electrónico que utilizó para registrarse en AgentFlow y le enviaremos un correo electrónico de restablecimiento de contraseña.',
  ...
  licenseInactiveTip: 'La licencia de AgentFlow Enterprise para su espacio de trabajo está inactiva. Póngase en contacto con su administrador para seguir utilizando AgentFlow.',
  licenseExpired: 'Licencia caducada',
  licenseLost: 'Licencia perdida',
  licenseExpiredTip: 'La licencia de AgentFlow Enterprise para su espacio de trabajo ha caducado. Póngase en contacto con su administrador para seguir utilizando AgentFlow.',
  licenseLostTip: 'No se pudo conectar el servidor de licencias de Dife. Póngase en contacto con su administrador para seguir utilizando AgentFlow.',
  webapp: {
