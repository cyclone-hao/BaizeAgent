const translation = {
  ...
  welcome: 'Bine ai venit la AgentFlow, te rugăm să te autentifici pentru a continua.',
  ...
  license: {
    tip: 'Înainte de a începe AgentFlow Community Edition, citește',
    link: 'Licența open-source de pe GitHub',
  },
  join: 'Alătură-te',
  joinTipStart: 'Te invităm să te alături echipei',
  joinTipEnd: 'pe AgentFlow',
  invalid: 'Link-ul a expirat',
  explore: 'Explorează AgentFlow',
  ...
  or: 'SAU',
  resetPasswordDesc: 'Tastați e-mailul pe care l-ați folosit pentru a vă înscrie pe AgentFlow și vă vom trimite un e-mail de resetare a parolei.',
  changePasswordBtn: 'Setați o parolă',
  licenseLostTip: 'Nu s-a reușit conectarea serverului de licențe AgentFlow. Contactați administratorul pentru a continua să utilizați AgentFlow.',
  licenseInactive: 'Licență inactivă',
  licenseInactiveTip: 'Licența AgentFlow Enterprise pentru spațiul de lucru este inactivă. Contactați administratorul pentru a continua să utilizați AgentFlow.',
  licenseExpired: 'Licență expirată',
  licenseLost: 'Licență pierdută',
  licenseExpiredTip: 'Licența AgentFlow Enterprise pentru spațiul de lucru a expirat. Contactați administratorul pentru a continua să utilizați AgentFlow.',
  webapp: {
