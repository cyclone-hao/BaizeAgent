const translation = {
  ...
  apiKeyInfo: {
    ...
    tryCloud: 'Sau încercați versiunea cloud a AgentFlow cu cotă gratuită',
  },
  overview: {
    ...
    appInfo: {
      ...
      settings: {
        ...
        more: {
          ...
          privacyPolicyTip: 'Ajută vizitatorii să înțeleagă datele pe care le colectează aplicația, consultați <privacyPolicyLink>Politica de confidențialitate</privacyPolicyLink> a AgentFlow.',
      ...
      embedded: {
        ...
        chromePlugin: 'Instalați extensia Chrome AgentFlow Chatbot',
        copied: 'Copiat',
        copy: 'Copiați',
      },
      qrcode: {
