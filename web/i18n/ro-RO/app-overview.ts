const translation = {
  ...
  apiKeyInfo: {
    ...
    tryCloud: 'Sau încercați versiunea cloud a 白泽智能体平台 cu cotă gratuită',
  },
  overview: {
    ...
    appInfo: {
      ...
      settings: {
        ...
        more: {
          ...
          privacyPolicyTip: 'Ajută vizitatorii să înțeleagă datele pe care le colectează aplicația, consultați <privacyPolicyLink>Politica de confidențialitate</privacyPolicyLink> a 白泽智能体平台.',
      ...
      embedded: {
        ...
        chromePlugin: 'Instalați extensia Chrome 白泽智能体平台 Chatbot',
        copied: 'Copiat',
        copy: 'Copiați',
      },
      qrcode: {
