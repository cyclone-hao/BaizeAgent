const translation = {
  ...
  difyVersionNotCompatible: 'Versiunea curentă AgentFlow nu este compatibilă cu acest plugin, vă rugăm să faceți upgrade la versiunea minimă necesară: {{minimalDifyVersion}}',
