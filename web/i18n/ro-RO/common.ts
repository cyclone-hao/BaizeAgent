const translation = {
  ...
  members: {
    ...
    invitationSentTip: 'Invitația a fost trimisă și pot să se autentifice în AgentFlow pentru a accesa datele echipei dvs.',
  ...
  provider: {
    ...
    openaiHosted: {
      ...
      desc: 'Serviciul de găzduire OpenAI furnizat de AgentFlow vă permite să utilizați modele precum GPT-3.5. Înainte ca cota de probă să fie epuizată, trebuie să configurați alți furnizori de modele.',
      callTimes: 'Apeluri',
  ...
  apiBasedExtension: {
    title: 'Extensiile bazate pe API oferă o gestionare centralizată a API-urilor, simplificând configurația pentru o utilizare ușoară în aplicațiile AgentFlow.',
  ...
  about: {
    ...
    nowAvailable: 'AgentFlow {{version}} este acum disponibil.',
    latestAvailable: 'AgentFlow {{version}} este ultima versiune disponibilă.',
  },
  appMenus: {
