const translation = {
  ...
  account: {
    ...
    langGeniusAccount: 'Cont 白泽智能体平台',
    langGeniusAccountTip: 'Contul 白泽智能体平台 și datele de utilizator asociate.',
  ...
  members: {
    ...
    invitationSentTip: 'Invitația a fost trimisă și pot să se autentifice în 白泽智能体平台 pentru a accesa datele echipei dvs.',
  ...
  provider: {
    ...
    openaiHosted: {
      ...
      desc: 'Serviciul de găzduire OpenAI furnizat de 白泽智能体平台 vă permite să utilizați modele precum GPT-3.5. Înainte ca cota de probă să fie epuizată, trebuie să configurați alți furnizori de modele.',
      callTimes: 'Apeluri',
  ...
  apiBasedExtension: {
    title: 'Extensiile bazate pe API oferă o gestionare centralizată a API-urilor, simplificând configurația pentru o utilizare ușoară în aplicațiile 白泽智能体平台.',
  ...
  about: {
    ...
    nowAvailable: '白泽智能体平台 {{version}} este acum disponibil.',
    latestAvailable: '白泽智能体平台 {{version}} este ultima versiune disponibilă.',
  },
  appMenus: {
