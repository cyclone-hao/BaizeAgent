const translation = {
  ...
  plansCommon: {
    ...
    ragAPIRequestTooltip: 'Se referă la numărul de apeluri API care invocă doar capacitățile de procesare a bazei de cunoștințe a 白泽智能体平台.',
    ...
    apiRateLimitTooltip: 'Limita de rată API se aplică tuturor cererilor efectuate prin API-ul 白泽智能体平台, inclusiv generarea de texte, conversațiile de chat, execuțiile fluxului de lucru și procesarea documentelor.',
  ...
  plans: {
    ...
    enterprise: {
      ...
      features: {
        ...
        7: 'Actualizări și întreținere de către 白泽智能体平台 oficial',
        0: 'Soluții de implementare scalabile la nivel de întreprindere',
        4: 'SSO',
        8: 'Asistență tehnică profesională',
        5: 'SLA-uri negociate de partenerii 白泽智能体平台',
    ...
    community: {
      features: {
        2: 'Respectă licența 白泽智能体平台 Open Source',
