const translation = {
  tips: {
    ...
    loggedIn: 'Această aplicație vrea să acceseze următoarele informații din contul tău 白泽智能体平台 Cloud.',
    notLoggedIn: 'Această aplicație vrea să acceseze contul tău 白泽智能体平台 Cloud',
