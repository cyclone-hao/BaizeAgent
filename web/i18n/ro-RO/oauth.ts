const translation = {
  tips: {
    ...
    loggedIn: 'Această aplicație vrea să acceseze următoarele informații din contul tău AgentFlow Cloud.',
    notLoggedIn: 'Această aplicație vrea să acceseze contul tău AgentFlow Cloud',
