const translation = {
  ...
  account: {
    ...
    langGeniusAccount: 'Conta 白泽智能体平台',
    langGeniusAccountTip: 'Sua conta 白泽智能体平台 e dados de usuário associados.',
  ...
  members: {
    ...
    invitationSentTip: 'Convite enviado e eles podem fazer login no 白泽智能体平台 para acessar os dados da sua equipe.',
  ...
  provider: {
    ...
    openaiHosted: {
      ...
      desc: 'O serviço de hospedagem OpenAI fornecido pela 白泽智能体平台 permite que você use modelos como GPT-3.5. Antes que sua cota de teste seja esgotada, você precisa configurar outros fornecedores de modelos.',
      callTimes: 'Chamadas',
  ...
  apiBasedExtension: {
    title: 'As extensões de API fornecem gerenciamento centralizado de API, simplificando a configuração para uso fácil em todos os aplicativos da 白泽智能体平台.',
  ...
  about: {
    ...
    nowAvailable: '白泽智能体平台 {{version}} já está disponível.',
    latestAvailable: '白泽智能体平台 {{version}} é a última versão disponível.',
  },
  appMenus: {
