const translation = {
  ...
  apiKeyInfo: {
    ...
    tryCloud: 'Ou experimente a versão em nuvem do 白泽智能体平台 com cota gratuita',
  },
  overview: {
    title: 'Visão Geral',
    appInfo: {
      ...
      settings: {
        ...
        more: {
          ...
          privacyPolicyTip: 'Ajuda os visitantes a entender os dados coletados pelo aplicativo, consulte a <privacyPolicyLink>Política de Privacidade</privacyPolicyLink> do 白泽智能体平台.',
      ...
      embedded: {
        ...
        chromePlugin: 'Instalar a Extensão do Chrome 白泽智能体平台 Chatbot',
        copied: 'Copiado',
        copy: 'Copiar',
      },
      qrcode: {
      ...
      customize: {
        ...
        way1: {
          ...
          step1Operation: 'Cliente-Web-白泽智能体平台',
