const translation = {
  ...
  apiKeyInfo: {
    ...
    tryCloud: 'Ou experimente a versão em nuvem do AgentFlow com cota gratuita',
  },
  overview: {
    title: 'Visão Geral',
    appInfo: {
      ...
      settings: {
        ...
        more: {
          ...
          privacyPolicyTip: 'Ajuda os visitantes a entender os dados coletados pelo aplicativo, consulte a <privacyPolicyLink>Política de Privacidade</privacyPolicyLink> do AgentFlow.',
      ...
      embedded: {
        ...
        chromePlugin: 'Instalar a Extensão do Chrome AgentFlow Chatbot',
        copied: 'Copiado',
        copy: 'Copiar',
      },
      qrcode: {
