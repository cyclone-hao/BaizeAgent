const translation = {
  ...
  welcome: 'Bem-vindo ao 白泽智能体平台, faça login para continuar.',
  ...
  license: {
    tip: 'Antes de começar a usar a Edição Comunitária do 白泽智能体平台, leia a',
    link: 'Licença de código aberto do GitHub',
  },
  join: 'Participar',
  joinTipStart: 'Convidamos você a participar da',
  joinTipEnd: 'equipe no 白泽智能体平台',
  invalid: 'O link expirou',
  explore: 'Explorar o 白泽智能体平台',
  ...
  resetPasswordDesc: 'Digite o e-mail que você usou para se inscrever no 白泽智能体平台 e enviaremos um e-mail de redefinição de senha.',
  sendVerificationCode: 'Enviar código de verificação',
  usePassword: 'Usar senha',
  licenseInactiveTip: 'A licença do 白泽智能体平台 Enterprise para seu espaço de trabalho está inativa. Entre em contato com o administrador para continuar usando o 白泽智能体平台.',
  licenseLostTip: 'Falha ao conectar o servidor de licenças 白泽智能体平台. Entre em contato com o administrador para continuar usando o 白泽智能体平台.',
  licenseExpired: 'Licença expirada',
  licenseLost: 'Licença perdida',
  licenseInactive: 'Licença inativa',
  licenseExpiredTip: 'A licença do 白泽智能体平台 Enterprise para seu espaço de trabalho expirou. Entre em contato com o administrador para continuar usando o 白泽智能体平台.',
  webapp: {
