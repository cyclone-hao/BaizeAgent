const translation = {
  ...
  welcome: 'Bem-vindo ao AgentFlow, faça login para continuar.',
  ...
  license: {
    tip: 'Antes de começar a usar a Edição Comunitária do AgentFlow, leia a',
    link: 'Licença de código aberto do GitHub',
  },
  join: 'Participar',
  joinTipStart: 'Convidamos você a participar da',
  joinTipEnd: 'equipe no AgentFlow',
  invalid: 'O link expirou',
  explore: 'Explorar o AgentFlow',
  ...
  resetPasswordDesc: 'Digite o e-mail que você usou para se inscrever no AgentFlow e enviaremos um e-mail de redefinição de senha.',
  sendVerificationCode: 'Enviar código de verificação',
  usePassword: 'Usar senha',
  licenseInactiveTip: 'A licença do AgentFlow Enterprise para seu espaço de trabalho está inativa. Entre em contato com o administrador para continuar usando o AgentFlow.',
  licenseLostTip: 'Falha ao conectar o servidor de licenças AgentFlow. Entre em contato com o administrador para continuar usando o AgentFlow.',
  licenseExpired: 'Licença expirada',
  licenseLost: 'Licença perdida',
  licenseInactive: 'Licença inativa',
  licenseExpiredTip: 'A licença do AgentFlow Enterprise para seu espaço de trabalho expirou. Entre em contato com o administrador para continuar usando o AgentFlow.',
  webapp: {
