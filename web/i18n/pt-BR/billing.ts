const translation = {
  ...
  plansCommon: {
    ...
    ragAPIRequestTooltip: 'Refere-se ao número de chamadas de API que invocam apenas as capacidades de processamento da base de conhecimento do 白泽智能体平台.',
    ...
    apiRateLimitTooltip: 'O limite da taxa da API se aplica a todas as solicitações feitas através da API 白泽智能体平台, incluindo geração de texto, conversas de chat, execuções de fluxo de trabalho e processamento de documentos.',
  ...
  plans: {
    ...
    enterprise: {
      ...
      features: {
        7: 'Atualizações e manutenção por 白泽智能体平台 oficialmente',
        ...
        5: 'SLAs negociados pela 白泽智能体平台 Partners',
    ...
    community: {
      features: {
        ...
        2: 'Está em conformidade com a licença de código aberto 白泽智能体平台',
      },
      name: 'Comunidade',
