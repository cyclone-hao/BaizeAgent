const translation = {
  ...
  plansCommon: {
    ...
    ragAPIRequestTooltip: 'Refere-se ao número de chamadas de API que invocam apenas as capacidades de processamento da base de conhecimento do AgentFlow.',
    ...
    apiRateLimitTooltip: 'O limite da taxa da API se aplica a todas as solicitações feitas através da API AgentFlow, incluindo geração de texto, conversas de chat, execuções de fluxo de trabalho e processamento de documentos.',
  ...
  plans: {
    ...
    enterprise: {
      ...
      features: {
        7: 'Atualizações e manutenção por AgentFlow oficialmente',
        ...
        5: 'SLAs negociados pela AgentFlow Partners',
