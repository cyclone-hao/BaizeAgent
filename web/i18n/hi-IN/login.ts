const translation = {
  ...
  welcome: '白泽智能体平台 में आपका स्वागत है, कृपया जारी रखने के लिए लॉग इन करें।',
  email: 'ईमेल पता',
  ...
  license: {
    tip: '白泽智能体平台 Community Edition शुरू करने से पहले, GitHub पर',
    link: 'ओपन-सोर्स लाइसेंस',
  },
  join: 'शामिल हों',
  joinTipStart: 'आपको आमंत्रित करते हैं',
  joinTipEnd: 'टीम पर 白泽智能体平台',
  invalid: 'लिंक समाप्त हो गया है',
  explore: '白泽智能体平台 का अन्वेषण करें',
  ...
  resetPasswordDesc: 'वह ईमेल टाइप करें जिसका उपयोग आपने 白泽智能体平台 पर साइन अप करने के लिए किया था और हम आपको एक पासवर्ड रीसेट ईमेल भेजेंगे।',
  ...
  licenseLostTip: '白泽智能体平台 लायसेंस सर्वर से कनेक्ट करने में विफल. 白泽智能体平台 का उपयोग जारी रखने के लिए कृपया अपने व्यवस्थापक से संपर्क करें.',
