const translation = {
  ...
  welcome: 'AgentFlow में आपका स्वागत है, कृपया जारी रखने के लिए लॉग इन करें।',
  email: 'ईमेल पता',
  ...
  license: {
    tip: 'AgentFlow Community Edition शुरू करने से पहले, GitHub पर',
  ...
  resetPasswordDesc: 'वह ईमेल टाइप करें जिसका उपयोग आपने AgentFlow पर साइन अप करने के लिए किया था और हम आपको एक पासवर्ड रीसेट ईमेल भेजेंगे।',
  ...
  licenseLostTip: 'AgentFlow लायसेंस सर्वर से कनेक्ट करने में विफल. AgentFlow का उपयोग जारी रखने के लिए कृपया अपने व्यवस्थापक से संपर्क करें.',
