const translation = {
  ...
  otherDataSource: {
    ...
    learnMore: 'और जानो',
    description: 'वर्तमान में, 白泽智能体平台 के ज्ञानकोष में केवल सीमित डेटा स्रोत हैं। 白泽智能体平台 नॉलेज बेस में डेटा स्रोत का योगदान करना सभी उपयोगकर्ताओं के लिए प्लेटफॉर्म के लचीलेपन और शक्ति को बढ़ाने में मदद करने का एक शानदार तरीका है। हमारी योगदान मार्गदर्शिका आरंभ करना आसान बनाती है। अधिक जानने के लिए कृपया नीचे दिए गए लिंक पर क्लिक करें।',
  },
  watercrawl: {
