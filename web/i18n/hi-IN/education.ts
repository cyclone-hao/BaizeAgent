const translation = {
  toVerifiedTip: {
    ...
    end: '白泽智能体平台 प्रोफेशनल योजना के लिए।',
  },
  form: {
    schoolName: {
    ...
    terms: {
      ...
      option: {
        ...
        inSchool: 'मैं पुष्टि करता हूँ कि मैं दी गई संस्थान में नामांकित या नियुक्त हूं। 白泽智能体平台 नामांकन/नियुक्ति का प्रमाण मांग सकता है। यदि मैं अपनी पात्रता का गलत वर्णन करता हूं, तो मैं सहमत हूं कि मैं अपने शिक्षा स्थिति के आधार पर किसी भी शुल्क का भुगतान करूं जो प्रारंभ में माफ किया गया था।',
      },
  ...
  successContent: 'हमने आपकी खाते के लिए 白泽智能体平台 प्रोफेशनल योजना के लिए 100% छूट कूपन जारी किया है। यह कूपन एक वर्ष के लिए मान्य है, कृपया इसे मान्यता की अवधि के भीतर उपयोग करें।',
  ...
  notice: {
    expired: {
      summary: {
        line1: 'आप अभी भी 白泽智能体平台 का उपयोग कर सकते हैं और इसे एक्सेस कर सकते हैं।',
