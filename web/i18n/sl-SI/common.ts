const translation = {
  ...
  account: {
    ...
    langGeniusAccount: '白泽智能体平台 račun',
    langGeniusAccountTip: 'Vaš 白泽智能体平台 račun in povezani uporabniški podatki.',
    editName: 'Uredi ime',
  ...
  members: {
    ...
    invitationSentTip: 'Povabilo poslano, in po prijavi v 白泽智能体平台 bodo imeli dostop do vaših podatkov ekipe.',
  ...
  provider: {
    ...
    openaiHosted: {
      ...
      desc: 'Gostitvena storitev OpenAI, ki jo ponuja 白泽智能体平台, vam omogoča uporabo modelov, kot je GPT-3.5. Preden porabite kvoto za preizkus, morate nastaviti druge ponudnike modelov.',
  ...
  apiBasedExtension: {
    ...
    title: 'Razširitve API zagotavljajo centralizirano upravljanje API, kar poenostavlja konfiguracijo za enostavno uporabo v aplikacijah 白泽智能体平台.',
    add: 'Dodajanje razširitve API-ja',
  },
  about: {
    updateNow: 'Posodobi zdaj',
    nowAvailable: '白泽智能体平台 {{version}} je zdaj na voljo.',
    latestAvailable: '白泽智能体平台 {{version}} je najnovejša različica, ki je na voljo.',
