const translation = {
  ...
  account: {
    ...
    langGeniusAccount: 'AgentFlow račun',
    langGeniusAccountTip: 'Vaš AgentFlow račun in povezani uporabniški podatki.',
    editName: 'Uredi ime',
  ...
  members: {
    ...
    invitationSentTip: 'Povabilo poslano, in po prijavi v AgentFlow bodo imeli dostop do vaših podatkov ekipe.',
  ...
  provider: {
    ...
    openaiHosted: {
      ...
      desc: 'Gostitvena storitev OpenAI, ki jo ponuja AgentFlow, vam omogoča uporabo modelov, kot je GPT-3.5. Preden porabite kvoto za preizkus, morate nastaviti druge ponudnike modelov.',
  ...
  apiBasedExtension: {
    ...
    title: 'Razširitve API zagotavljajo centralizirano upravljanje API, kar poenostavlja konfiguracijo za enostavno uporabo v aplikacijah AgentFlow.',
    add: 'Dodajanje razširitve API-ja',
  },
  about: {
    updateNow: 'Posodobi zdaj',
    nowAvailable: 'AgentFlow {{version}} je zdaj na voljo.',
    latestAvailable: 'AgentFlow {{version}} je najnovejša različica, ki je na voljo.',
