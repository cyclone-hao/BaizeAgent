const translation = {
  ...
  plansCommon: {
    ...
    ragAPIRequestTooltip: 'Nanaša se na število API klicev, ki vključujejo samo sposobnosti obdelave baze znanja 白泽智能体平台.',
    ...
    apiRateLimitTooltip: 'API omejitev hitrosti velja za vse poizvedbe, opravljene prek 白泽智能体平台 API, vključno z generiranjem besedila, klepetnimi pogovori, izvajanjem delovnih tokov in obdelavo dokumentov.',
  ...
  plans: {
    ...
    enterprise: {
      ...
      features: {
        ...
        7: 'Posodobitve in vzdrževanje s strani 白泽智能体平台 Official',
        5: 'Dogovorjene pogodbe o ravni storitev s strani 白泽智能体平台 Partners',
    ...
    community: {
      features: {
        2: 'Skladen z odprtokodno licenco 白泽智能体平台',
