const translation = {
  ...
  plansCommon: {
    ...
    ragAPIRequestTooltip: 'Nanaša se na število API klicev, ki vključujejo samo sposobnosti obdelave baze znanja AgentFlow.',
    ...
    apiRateLimitTooltip: 'API omejitev hitrosti velja za vse poizvedbe, opravljene prek AgentFlow API, vključno z generiranjem besedila, klepetnimi pogovori, izvajanjem delovnih tokov in obdelavo dokumentov.',
  ...
  plans: {
    ...
    enterprise: {
      ...
      features: {
        ...
        7: 'Posodobitve in vzdrževanje s strani AgentFlow Official',
        5: 'Dogovorjene pogodbe o ravni storitev s strani AgentFlow Partners',
