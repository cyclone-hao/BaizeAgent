const translation = {
  ...
  marketplace: {
    ...
    sortBy: 'Razvrsti po',
    verifiedTip: 'Verificirano s strani 白泽智能体平台',
    discover: 'Odkrijte',
    partnerTip: 'Potrjeno s strani partnerja 白泽智能体平台',
  ...
  difyVersionNotCompatible: 'Trenutna različica 白泽智能体平台 ni združljiva s to vtičnico, prosimo, posodobite na minimalno zahtevano različico: {{minimal白泽智能体平台Version}}',
