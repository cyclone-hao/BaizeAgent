const translation = {
  ...
  marketplace: {
    ...
    sortBy: 'Razvrsti po',
    verifiedTip: 'Verificirano s strani AgentFlow',
    discover: 'Odkrijte',
    partnerTip: 'Potrjeno s strani partnerja AgentFlow',
  ...
  difyVersionNotCompatible: 'Trenutna različica AgentFlow ni združljiva s to vtičnico, prosimo, posodobite na minimalno zahtevano različico: {{minimalAgentFlowVersion}}',
