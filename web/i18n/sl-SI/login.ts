const translation = {
  ...
  welcome: 'Dobrodošli v AgentFlow, prosimo, prijavite se za nadaljevanje.',
  ...
  license: {
    tip: 'Preden začnete z AgentFlow Community Edition, preberite GitHub',
    link: 'Licenco odprte kode',
  },
  join: 'Pridruži se',
  joinTipStart: 'Vabimo vas, da se pridružite',
  joinTipEnd: 'ekipi na AgentFlow',
  invalid: 'Povezava je potekla',
  explore: 'Razišči AgentFlow',
  ...
  licenseExpiredTip: 'Licenca za AgentFlow Enterprise za vaš delovni prostor je potekla. Če želite še naprej uporabljati AgentFlow, se obrnite na skrbnika.',
  usePassword: 'Uporaba gesla',
  sendVerificationCode: 'Pošlji kodo za preverjanje',
  resetPasswordDesc: 'Vnesite e-poštni naslov, ki ste ga uporabili za prijavo na AgentFlow, in poslali vam bomo e-poštno sporočilo za ponastavitev gesla.',
  ...
  licenseLostTip: 'Povezava z licenčnim strežnikom AgentFlow ni uspela. Če želite še naprej uporabljati AgentFlow, se obrnite na skrbnika.',
  licenseInactiveTip: 'Licenca AgentFlow Enterprise za vaš delovni prostor je neaktivna. Če želite še naprej uporabljati AgentFlow, se obrnite na skrbnika.',
  webapp: {
