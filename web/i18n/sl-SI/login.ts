const translation = {
  ...
  welcome: 'Dobrodošli v 白泽智能体平台, prosimo, prijavite se za nadaljevanje.',
  ...
  license: {
    tip: 'Preden začnete z 白泽智能体平台 Community Edition, preberite GitHub',
    link: 'Licenco odprte kode',
  },
  join: 'Pridruži se',
  joinTipStart: 'Vabimo vas, da se pridružite',
  joinTipEnd: 'ekipi na 白泽智能体平台',
  invalid: 'Povezava je potekla',
  explore: 'Razišči 白泽智能体平台',
  ...
  licenseExpiredTip: 'Licenca za 白泽智能体平台 Enterprise za vaš delovni prostor je potekla. Če želite še naprej uporabljati 白泽智能体平台, se obrnite na skrbnika.',
  usePassword: 'Uporaba gesla',
  sendVerificationCode: 'Pošlji kodo za preverjanje',
  resetPasswordDesc: 'Vnesite e-poštni naslov, ki ste ga uporabili za prijavo na 白泽智能体平台, in poslali vam bomo e-poštno sporočilo za ponastavitev gesla.',
  ...
  licenseLostTip: 'Povezava z licenčnim strežnikom 白泽智能体平台 ni uspela. Če želite še naprej uporabljati 白泽智能体平台, se obrnite na skrbnika.',
  licenseInactiveTip: 'Licenca 白泽智能体平台 Enterprise za vaš delovni prostor je neaktivna. Če želite še naprej uporabljati 白泽智能体平台, se obrnite na skrbnika.',
  webapp: {
