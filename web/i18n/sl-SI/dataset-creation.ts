const translation = {
  ...
  otherDataSource: {
    ...
    description: 'Trenutno ima baza znanja 白泽智能体平台 le omejene vire podatkov. Prispevanje vira podatkov v bazo znanja 白泽智能体平台 je fantastičen način za izboljšanje prilagodljivosti in moči platforme za vse uporabnike. Naš vodnik za prispevke olajša začetek. Če želite izvedeti več, kliknite spodnjo povezavo.',
  },
  watercrawl: {
