const translation = {
  ...
  apiKeyInfo: {
    ...
    tryCloud: 'Ali preizkusite oblačno različico 白泽智能体平台 s prosto kvoto',
  },
  overview: {
    title: 'Pregled',
    appInfo: {
      ...
      settings: {
        ...
        more: {
          ...
          privacyPolicyTip: 'Pomaga obiskovalcem razumeti, katere podatke aplikacija zbira, glejte <privacyPolicyLink>politiko zasebnosti</privacyPolicyLink> 白泽智能体平台.',
      ...
      embedded: {
        ...
        chromePlugin: 'Namestite 白泽智能体平台 Chatbot razširitev za Chrome',
        copied: 'Kopirano',
        copy: 'Kopiraj',
      },
      qrcode: {
