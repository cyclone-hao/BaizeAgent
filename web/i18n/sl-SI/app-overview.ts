const translation = {
  ...
  apiKeyInfo: {
    ...
    tryCloud: 'Ali preizkusite oblačno različico AgentFlow s prosto kvoto',
  },
  overview: {
    title: 'Pregled',
    appInfo: {
      ...
      settings: {
        ...
        more: {
          ...
          privacyPolicyTip: 'Pomaga obiskovalcem razumeti, katere podatke aplikacija zbira, glejte <privacyPolicyLink>politiko zasebnosti</privacyPolicyLink> AgentFlow.',
      ...
      embedded: {
        ...
        chromePlugin: 'Namestite AgentFlow Chatbot razširitev za Chrome',
        copied: 'Kopirano',
        copy: 'Kopiraj',
      },
      qrcode: {
