const translation = {
  ...
  members: {
    ...
    invitationSentTip: 'Undangan terkirim, dan mereka dapat masuk ke AgentFlow untuk mengakses data tim Anda.',
    role: 'PERAN',
    ok: 'OKE',
  ...
  provider: {
    ...
    openaiHosted: {
      desc: 'Layanan hosting OpenAI yang disediakan oleh AgentFlow memungkinkan Anda menggunakan model seperti GPT-3.5. Sebelum kuota uji coba habis, Anda harus menyiapkan penyedia model lain.',
  ...
  apiBasedExtension: {
    ...
    title: 'Ekstensi API menyediakan manajemen API terpusat, menyederhanakan konfigurasi agar mudah digunakan di seluruh aplikasi AgentFlow.',
    type: 'Jenis',
