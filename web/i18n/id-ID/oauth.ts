const translation = {
  tips: {
    loggedIn: 'Aplikasi ini ingin mengakses informasi berikut dari akun AgentFlow Cloud Anda.',
    notLoggedIn: 'Aplikasi ini ingin mengakses akun AgentFlow Cloud Anda',
