const translation = {
  ...
  license: {
    tip: 'Sebelum memulai Edisi Komunitas AgentFlow, baca GitHub',
  ...
  joinTipEnd: 'tim di AgentFlow',
  dontHave: 'Belum?',
  passwordChangedTip: 'Kata sandi Anda telah berhasil diubah',
  validate: 'Memvalidasi',
  resetPasswordDesc: 'Ketik email yang Anda gunakan untuk mendaftar di AgentFlow dan kami akan mengirimkan email reset kata sandi kepada Anda.',
  licenseLostTip: 'Gagal menghubungkan server lisensi AgentFlow. Hubungi administrator Anda untuk terus menggunakan AgentFlow.',
  signBtn: 'Masuk',
  sendResetLink: 'Kirim tautan reset',
  createAndSignIn: 'Buat dan masuk',
  licenseExpiredTip: 'Lisensi AgentFlow Enterprise untuk ruang kerja Anda telah kedaluwarsa. Hubungi administrator Anda untuk terus menggunakan AgentFlow.',
  email: 'Alamat email',
  noLoginMethodTip: 'Silakan hubungi admin sistem untuk menambahkan metode autentikasi.',
  adminInitPassword: 'Kata sandi inisialisasi admin',
  licenseInactiveTip: 'Lisensi AgentFlow Enterprise untuk ruang kerja Anda tidak aktif. Hubungi administrator Anda untuk terus menggunakan AgentFlow.',
  rightTitle: 'Buka potensi penuh LLM',
  welcome: '👋 Selamat datang di AgentFlow, silakan login untuk melanjutkan.',
