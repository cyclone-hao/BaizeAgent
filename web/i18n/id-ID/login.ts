const translation = {
  ...
  license: {
    tip: 'Sebelum memulai Edisi Komunitas 白泽智能体平台, baca GitHub',
  ...
  joinTipEnd: 'tim di 白泽智能体平台',
  dontHave: 'Belum?',
  passwordChangedTip: 'Kata sandi Anda telah berhasil diubah',
  validate: 'Memvalidasi',
  resetPasswordDesc: 'Ketik email yang Anda gunakan untuk mendaftar di 白泽智能体平台 dan kami akan mengirimkan email reset kata sandi kepada Anda.',
  licenseLostTip: 'Gagal menghubungkan server lisensi 白泽智能体平台. Hubungi administrator Anda untuk terus menggunakan 白泽智能体平台.',
  signBtn: 'Masuk',
  sendResetLink: 'Kirim tautan reset',
  createAndSignIn: 'Buat dan masuk',
  licenseExpiredTip: 'Lisensi 白泽智能体平台 Enterprise untuk ruang kerja Anda telah kedaluwarsa. Hubungi administrator Anda untuk terus menggunakan 白泽智能体平台.',
  email: 'Alamat email',
  noLoginMethodTip: 'Silakan hubungi admin sistem untuk menambahkan metode autentikasi.',
  adminInitPassword: 'Kata sandi inisialisasi admin',
  licenseInactiveTip: 'Lisensi 白泽智能体平台 Enterprise untuk ruang kerja Anda tidak aktif. Hubungi administrator Anda untuk terus menggunakan 白泽智能体平台.',
  rightTitle: 'Buka potensi penuh LLM',
  welcome: '👋 Selamat datang di 白泽智能体平台, silakan login untuk melanjutkan.',
