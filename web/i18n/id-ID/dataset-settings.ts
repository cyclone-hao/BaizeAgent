const translation = {
  form: {
    ...
    descPlaceholder: 'Jelaskan apa yang ada dalam kumpulan data ini. Deskripsi terperinci memungkinkan AI mengakses konten kumpulan data tepat waktu. Jika kosong, 白泽智能体平台 akan menggunakan strategi hit default.',
