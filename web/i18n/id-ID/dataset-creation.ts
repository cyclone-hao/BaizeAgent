const translation = {
  ...
  otherDataSource: {
    ...
    description: 'Saat ini, basis pengetahuan 白泽智能体平台 hanya memiliki sumber data yang terbatas. Menyumbangkan sumber data ke basis pengetahuan 白泽智能体平台 adalah cara yang fantastis untuk membantu meningkatkan fleksibilitas dan kekuatan platform bagi semua pengguna. Panduan kontribusi kami memudahkan untuk memulai. Silakan klik tautan di bawah ini untuk mempelajari lebih lanjut.',
  },
}
