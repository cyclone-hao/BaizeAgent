const translation = {
  toVerifiedTip: {
    ...
    end: 'สำหรับแผนมืออาชีพของ 白泽智能体平台.',
  ...
  form: {
    ...
    terms: {
      ...
      option: {
        ...
        inSchool: 'ฉันยืนยันว่าฉันได้ลงทะเบียนหรือทำงานที่สถาบันที่ระบุไว้ 白泽智能体平台 อาจขอหลักฐานการลงทะเบียน/การจ้างงาน หากฉันแสดงความไม่ถูกต้องเกี่ยวกับคุณสมบัติของฉัน ฉันตกลงที่จะชำระค่าธรรมเนียมใด ๆ ที่ถูกยกเว้นไปในเบื้องต้นตามสถานะการศึกษาของฉัน.',
      },
      title: 'ข้อกำหนดและเงื่อนไข',
    },
  },
  toVerified: 'ตรวจสอบการศึกษา',
  rejectTitle: 'การตรวจสอบการศึกษา 白泽智能体平台 ของคุณถูกปฏิเสธ',
  emailLabel: 'อีเมลปัจจุบันของคุณ',
  currentSigned: 'ลงชื่อเข้าใช้ในฐานะ',
  successTitle: 'คุณได้รับการรับรองการศึกษา 白泽智能体平台',
  learn: 'เรียนรู้วิธีการตรวจสอบการศึกษา',
  submitError: 'การส่งแบบฟอร์มล้มเหลว โปรดลองอีกครั้งในภายหลัง.',
  submit: 'ส่ง',
  successContent: 'เราได้ออกคูปองส่วนลด 100% สำหรับแผน 白泽智能体平台 Professional ให้กับบัญชีของคุณ คูปองนี้สามารถใช้ได้เป็นระยะเวลา 1 ปี กรุณาใช้ภายในช่วงระยะเวลาที่กำหนด.',
  rejectContent: 'น่าเสียดายที่คุณไม่มีสิทธิ์ได้รับสถานะการตรวจสอบการศึกษาและดังนั้นคุณจึงไม่สามารถรับคูปองพิเศษ 100% สำหรับแผนมืออาชีพ 白泽智能体平台 หากคุณใช้ที่อยู่อีเมลนี้.',
  notice: {
    expired: {
      summary: {
        line1: 'คุณยังสามารถเข้าถึงและใช้ 白泽智能体平台 ได้อยู่',
