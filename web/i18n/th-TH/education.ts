const translation = {
  toVerifiedTip: {
    ...
    end: 'สำหรับแผนมืออาชีพของ AgentFlow.',
  ...
  form: {
    ...
    terms: {
      ...
      option: {
        ...
        inSchool: 'ฉันยืนยันว่าฉันได้ลงทะเบียนหรือทำงานที่สถาบันที่ระบุไว้ AgentFlow อาจขอหลักฐานการลงทะเบียน/การจ้างงาน หากฉันแสดงความไม่ถูกต้องเกี่ยวกับคุณสมบัติของฉัน ฉันตกลงที่จะชำระค่าธรรมเนียมใด ๆ ที่ถูกยกเว้นไปในเบื้องต้นตามสถานะการศึกษาของฉัน.',
      },
  ...
  submit: 'ส่ง',
  successContent: 'เราได้ออกคูปองส่วนลด 100% สำหรับแผน AgentFlow Professional ให้กับบัญชีของคุณ คูปองนี้สามารถใช้ได้เป็นระยะเวลา 1 ปี กรุณาใช้ภายในช่วงระยะเวลาที่กำหนด.',
  rejectContent: 'น่าเสียดายที่คุณไม่มีสิทธิ์ได้รับสถานะการตรวจสอบการศึกษาและดังนั้นคุณจึงไม่สามารถรับคูปองพิเศษ 100% สำหรับแผนมืออาชีพ AgentFlow หากคุณใช้ที่อยู่อีเมลนี้.',
  notice: {
    expired: {
      summary: {
        line1: 'คุณยังสามารถเข้าถึงและใช้ AgentFlow ได้อยู่',
