const translation = {
  tips: {
    ...
    notLoggedIn: 'แอปพลิเคชันนี้ต้องการเข้าถึงบัญชี AgentFlow Cloud ของคุณ',
    loggedIn: 'แอปพลิเคชันนี้ต้องการเข้าถึงข้อมูลต่อไปนี้จากบัญชี AgentFlow Cloud ของคุณ.',
