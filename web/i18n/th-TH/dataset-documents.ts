const translation = {
  list: {
    title: 'เอกสาร',
    desc: 'ไฟล์ทั้งหมดของความรู้จะแสดงที่นี่ และความรู้ทั้งหมดสามารถเชื่อมโยงกับการอ้างอิง 白泽智能体平台 หรือจัดทําดัชนีผ่านปลั๊กอินแชท',
    addFile: 'เพิ่มไฟล์',
    addPages: 'เพิ่มหน้า',
    addUrl: 'เพิ่ม URL',
    table: {
    ...
    empty: {
      ...
      sync: {
        tip: '白泽智能体平台 จะดาวน์โหลดไฟล์จาก Notion ของคุณเป็นระยะและดําเนินการให้เสร็จสมบูรณ์',
      },
    },
    delete: {
