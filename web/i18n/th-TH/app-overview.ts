const translation = {
  ...
  apiKeyInfo: {
    ...
    tryCloud: 'หรือลองใช้ 白泽智能体平台 เวอร์ชันคลาวด์พร้อมใบเสนอราคาฟรี',
  },
  overview: {
    title: 'ภาพรวม',
    appInfo: {
      ...
      settings: {
        ...
        more: {
          ...
          privacyPolicyTip: 'ช่วยให้ผู้เยี่ยมชมเข้าใจข้อมูลที่แอปพลิเคชันรวบรวม โปรดดูนโยบาย<privacyPolicyLink>ความเป็นส่วนตัว</privacyPolicyLink>ของ 白泽智能体平台',
      ...
      embedded: {
        ...
        chromePlugin: 'ติดตั้งส่วนขยาย 白泽智能体平台 Chatbot Chrome',
        copied: 'คัด ลอก',
        copy: 'ลอก',
      },
      qrcode: {
      ...
      customize: {
        ...
        way1: {
          ...
          step1Operation: '白泽智能体平台-Web ไคลเอ็นต์',
