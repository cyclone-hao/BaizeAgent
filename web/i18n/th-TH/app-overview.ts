const translation = {
  ...
  apiKeyInfo: {
    ...
    tryCloud: 'หรือลองใช้ AgentFlow เวอร์ชันคลาวด์พร้อมใบเสนอราคาฟรี',
  },
  overview: {
    title: 'ภาพรวม',
    appInfo: {
      ...
      embedded: {
        ...
        chromePlugin: 'ติดตั้งส่วนขยาย AgentFlow Chatbot Chrome',
        copied: 'คัด ลอก',
        copy: 'ลอก',
      },
      qrcode: {
      ...
      customize: {
        ...
        way1: {
          ...
          step1Operation: 'AgentFlow-Web ไคลเอ็นต์',
