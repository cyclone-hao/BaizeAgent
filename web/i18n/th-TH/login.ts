const translation = {
  ...
  welcome: '👋 ยินดีต้อนรับสู่ AgentFlow โปรดเข้าสู่ระบบเพื่อดําเนินการต่อ',
  email: 'ที่อยู่อีเมล',
  ...
  license: {
    tip: 'ก่อนเริ่ม AgentFlow Community Edition โปรดอ่าน GitHub',
    link: 'ใบอนุญาตโอเพ่นซอร์ส',
  },
  join: 'ต่อ',
  joinTipStart: 'เชิญคุณเข้าร่วม',
  joinTipEnd: 'ทีมงานใน AgentFlow',
  invalid: 'ลิงก์หมดอายุ',
  explore: 'สํารวจ AgentFlow',
  ...
  resetPasswordDesc: 'พิมพ์อีเมลที่คุณใช้ลงทะเบียนบน AgentFlow แล้วเราจะส่งอีเมลรีเซ็ตรหัสผ่านให้คุณ',
  ...
  licenseExpiredTip: 'สิทธิ์การใช้งาน AgentFlow Enterprise สําหรับพื้นที่ทํางานของคุณหมดอายุแล้ว โปรดติดต่อผู้ดูแลระบบของคุณเพื่อใช้ AgentFlow ต่อไป',
  licenseLost: 'ใบอนุญาตสูญหาย',
  licenseLostTip: 'เชื่อมต่อเซิร์ฟเวอร์ใบอนุญาต AgentFlow ไม่สําเร็จ โปรดติดต่อผู้ดูแลระบบของคุณเพื่อใช้ AgentFlow ต่อไป',
  licenseInactive: 'ใบอนุญาตไม่ใช้งาน',
  licenseInactiveTip: 'สิทธิ์การใช้งาน AgentFlow Enterprise สําหรับพื้นที่ทํางานของคุณไม่ได้ใช้งาน โปรดติดต่อผู้ดูแลระบบของคุณเพื่อใช้ AgentFlow ต่อไป',
  webapp: {
