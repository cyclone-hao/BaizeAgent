const translation = {
  ...
  welcome: '👋 ยินดีต้อนรับสู่ 白泽智能体平台 โปรดเข้าสู่ระบบเพื่อดําเนินการต่อ',
  email: 'ที่อยู่อีเมล',
  ...
  license: {
    tip: 'ก่อนเริ่ม 白泽智能体平台 Community Edition โปรดอ่าน GitHub',
    link: 'ใบอนุญาตโอเพ่นซอร์ส',
  },
  join: 'ต่อ',
  joinTipStart: 'เชิญคุณเข้าร่วม',
  joinTipEnd: 'ทีมงานใน 白泽智能体平台',
  invalid: 'ลิงก์หมดอายุ',
  explore: 'สํารวจ 白泽智能体平台',
  ...
  resetPasswordDesc: 'พิมพ์อีเมลที่คุณใช้ลงทะเบียนบน 白泽智能体平台 แล้วเราจะส่งอีเมลรีเซ็ตรหัสผ่านให้คุณ',
  ...
  licenseExpiredTip: 'สิทธิ์การใช้งาน 白泽智能体平台 Enterprise สําหรับพื้นที่ทํางานของคุณหมดอายุแล้ว โปรดติดต่อผู้ดูแลระบบของคุณเพื่อใช้ 白泽智能体平台 ต่อไป',
  licenseLost: 'ใบอนุญาตสูญหาย',
  licenseLostTip: 'เชื่อมต่อเซิร์ฟเวอร์ใบอนุญาต 白泽智能体平台 ไม่สําเร็จ โปรดติดต่อผู้ดูแลระบบของคุณเพื่อใช้ 白泽智能体平台 ต่อไป',
  licenseInactive: 'ใบอนุญาตไม่ใช้งาน',
  licenseInactiveTip: 'สิทธิ์การใช้งาน 白泽智能体平台 Enterprise สําหรับพื้นที่ทํางานของคุณไม่ได้ใช้งาน โปรดติดต่อผู้ดูแลระบบของคุณเพื่อใช้ 白泽智能体平台 ต่อไป',
  webapp: {
