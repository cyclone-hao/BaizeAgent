const translation = {
  ...
  plansCommon: {
    ...
    ragAPIRequestTooltip: 'หมายถึงจํานวนการเรียก API ที่เรียกใช้เฉพาะความสามารถในการประมวลผลฐานความรู้ของ 白泽智能体平台',
    ...
    apiRateLimitTooltip: 'ข้อจำกัดการใช้งาน API จะใช้กับคำขอทั้งหมดที่ทำผ่าน 白泽智能体平台 API รวมถึงการสร้างข้อความ, การสนทนาแชท, การดำเนินการเวิร์กโฟลว์ และการประมวลผลเอกสาร.',
  ...
  plans: {
    ...
    enterprise: {
      ...
      features: {
        4: 'SSO',
        5: 'SLA ที่เจรจาโดย 白泽智能体平台 Partners',
        ...
        7: 'การอัปเดตและบํารุงรักษาโดย 白泽智能体平台 อย่างเป็นทางการ',
      },
    ...
    community: {
      features: {
        ...
        2: 'สอดคล้องกับใบอนุญาตโอเพ่นซอร์ส 白泽智能体平台',
