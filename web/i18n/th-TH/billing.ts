const translation = {
  ...
  plansCommon: {
    ...
    ragAPIRequestTooltip: 'หมายถึงจํานวนการเรียก API ที่เรียกใช้เฉพาะความสามารถในการประมวลผลฐานความรู้ของ AgentFlow',
    ...
    apiRateLimitTooltip: 'ข้อจำกัดการใช้งาน API จะใช้กับคำขอทั้งหมดที่ทำผ่าน AgentFlow API รวมถึงการสร้างข้อความ, การสนทนาแชท, การดำเนินการเวิร์กโฟลว์ และการประมวลผลเอกสาร.',
  ...
  plans: {
    ...
    enterprise: {
      ...
      features: {
        4: 'SSO',
        5: 'SLA ที่เจรจาโดย AgentFlow Partners',
        ...
        7: 'การอัปเดตและบํารุงรักษาโดย AgentFlow อย่างเป็นทางการ',
      },
    ...
    community: {
      features: {
        ...
        2: 'สอดคล้องกับใบอนุญาตโอเพ่นซอร์ส AgentFlow',
