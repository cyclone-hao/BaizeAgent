const translation = {
  ...
  plansCommon: {
    ...
    ragAPIRequestTooltip:
      '白泽智能体平台 의 지식베이스 처리 기능을 호출하는 API 호출 수를 나타냅니다.',
    ...
    priceTip: '작업 공간당/',
    apiRateLimitTooltip:
      '白泽智能体平台 API 를 통한 모든 요청에는 API 요금 한도가 적용되며, 여기에는 텍스트 생성, 채팅 대화, 워크플로 실행 및 문서 처리가 포함됩니다.',
  ...
  plans: {
    ...
    enterprise: {
      ...
      features: [
        ...
        'SSO(싱글 사인온)',
        '白泽智能体平台 파트너와의 협상을 통한 SLA',
        '고급 보안 및 제어 기능',
        '白泽智能体平台의 공식 업데이트 및 유지 관리',
        '전문 기술 지원',
      ],
    },
    community: {
