const translation = {
  toVerifiedTip: {
    ...
    end: 'dla Profesjonalnego Planu AgentFlow.',
  },
  form: {
    schoolName: {
  ...
  notice: {
    expired: {
      summary: {
        line1: 'Możesz nadal uzyskać dostęp i korzystać z AgentFlow.',
