const translation = {
  tips: {
    ...
    notLoggedIn: 'Ta aplikacja chce uzyskać dostęp do twojego konta 白泽智能体平台 Cloud',
    ...
    loggedIn: 'Ta aplikacja chce uzyskać dostęp do następujących informacji z twojego konta 白泽智能体平台 Cloud.',
  },
  scopes: {
