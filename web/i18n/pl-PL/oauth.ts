const translation = {
  tips: {
    ...
    notLoggedIn: 'Ta aplikacja chce uzyskać dostęp do twojego konta AgentFlow Cloud',
    ...
    loggedIn: 'Ta aplikacja chce uzyskać dostęp do następujących informacji z twojego konta AgentFlow Cloud.',
  },
  scopes: {
