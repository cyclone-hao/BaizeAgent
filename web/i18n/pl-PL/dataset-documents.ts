const translation = {
  list: {
    title: 'Dokumenty',
    desc: 'Wszystkie pliki wiedzy są tutaj pokazane, a cała wiedza może być powiązana z odnośnikami AgentFlow lub zindeksowana za pomocą wtyczki Chat.',
    addFile: 'dodaj plik',
    ...
    empty: {
      ...
      sync: {
        tip: 'AgentFlow regularnie pobiera pliki z Twojego Notion i dokonuje ich przetwarzania.',
      },
    },
    delete: {
