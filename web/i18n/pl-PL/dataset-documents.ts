const translation = {
  list: {
    title: 'Dokumenty',
    desc: 'Wszystkie pliki wiedzy są tutaj pokazane, a cała wiedza może być powiązana z odnośnikami 白泽智能体平台 lub zindeksowana za pomocą wtyczki Chat.',
    addFile: 'dodaj plik',
    ...
    empty: {
      ...
      sync: {
        tip: '白泽智能体平台 regularnie pobiera pliki z Twojego Notion i dokonuje ich przetwarzania.',
      },
    },
    delete: {
