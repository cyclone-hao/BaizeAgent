const translation = {
  ...
  welcome: 'Witaj w AgentFlow, zaloguj się, aby kontynuować.',
  email: 'Adres e-mail',
  ...
  license: {
    tip: 'Przed rozpoczęciem wersji społecznościowej AgentFlow, przeczytaj GitHub',
    link: 'Licencję open-source',
  },
  join: 'Dołącz',
  joinTipStart: 'Zapraszam Cię do dołączenia do',
  joinTipEnd: 'zespołu na AgentFlow',
  invalid: 'Link wygasł',
  explore: 'Odkryj AgentFlow',
  ...
  resetPasswordDesc: 'Wpisz adres e-mail, którego użyłeś do rejestracji w AgentFlow, a my wyślemy Ci wiadomość e-mail z prośbą o zresetowanie hasła.',
  or: 'LUB',
  ...
  licenseExpiredTip: 'Licencja AgentFlow Enterprise dla Twojego obszaru roboczego wygasła. Skontaktuj się z administratorem, aby kontynuować korzystanie z AgentFlow.',
  licenseLostTip: 'Nie udało się nawiązać połączenia z serwerem licencji AgentFlow. Skontaktuj się z administratorem, aby kontynuować korzystanie z AgentFlow.',
  licenseInactiveTip: 'Licencja AgentFlow Enterprise dla Twojego obszaru roboczego jest nieaktywna. Skontaktuj się z administratorem, aby kontynuować korzystanie z AgentFlow.',
  webapp: {
