const translation = {
  ...
  welcome: 'Witaj w 白泽智能体平台, zaloguj się, aby kontynuować.',
  email: 'Adres e-mail',
  ...
  license: {
    tip: 'Przed rozpoczęciem wersji społecznościowej 白泽智能体平台, przeczytaj GitHub',
    link: 'Licencję open-source',
  },
  join: 'Dołącz',
  joinTipStart: 'Zapraszam Cię do dołączenia do',
  joinTipEnd: 'zespołu na 白泽智能体平台',
  invalid: 'Link wygasł',
  explore: 'Odkryj 白泽智能体平台',
  ...
  resetPasswordDesc: 'Wpisz adres e-mail, którego użyłeś do rejestracji w 白泽智能体平台, a my wyślemy Ci wiadomość e-mail z prośbą o zresetowanie hasła.',
  or: 'LUB',
  ...
  licenseExpiredTip: 'Licencja 白泽智能体平台 Enterprise dla Twojego obszaru roboczego wygasła. Skontaktuj się z administratorem, aby kontynuować korzystanie z 白泽智能体平台.',
  licenseLostTip: 'Nie udało się nawiązać połączenia z serwerem licencji 白泽智能体平台. Skontaktuj się z administratorem, aby kontynuować korzystanie z 白泽智能体平台.',
  licenseInactiveTip: 'Licencja 白泽智能体平台 Enterprise dla Twojego obszaru roboczego jest nieaktywna. Skontaktuj się z administratorem, aby kontynuować korzystanie z 白泽智能体平台.',
  webapp: {
