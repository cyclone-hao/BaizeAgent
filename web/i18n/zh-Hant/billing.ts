const translation = {
  ...
  plansCommon: {
    ...
    ragAPIRequestTooltip: '指單獨呼叫 AgentFlow 知識庫資料處理能力的 API。',
    ...
    apiRateLimitTooltip: 'API 使用次數限制適用於通過 AgentFlow API 所做的所有請求，包括文本生成、聊天對話、工作流執行和文檔處理。',
    getStarted: '開始使用',
