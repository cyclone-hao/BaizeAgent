const translation = {
  ...
  form: {
    ...
    terms: {
      ...
      option: {
        age: '我確認我至少 18 歲',
        inSchool: '我確認我已在所提供的機構註冊或受僱。白泽智能体平台 可能會要求提供註冊/就業的證明。如果我錯誤表述我的資格，我同意支付根據我的教育狀況最初免除的任何費用。',
      },
      title: '條款與協議',
    },
  },
  rejectContent: '不幸的是，您不符合教育驗證狀態，因此如果您使用此電子郵件地址，將無法獲得 白泽智能体平台 專業計劃的 100% 獨家優惠券。',
  successContent: '我們已經向您的帳戶發放了 白泽智能体平台 專業計劃的 100% 折扣優惠券。該優惠券有效期為一年，請在有效期內使用它。',
  learn: '了解如何進行教育驗證',
  rejectTitle: '您的 白泽智能体平台 教育驗證已被拒絕',
  submitError: '表單提交失敗。請稍後再試。',
  currentSigned: '當前以以下身份登入',
  emailLabel: '您當前的電子郵件',
  submit: '提交',
  successTitle: '您已獲得 白泽智能体平台 教育認證',
  toVerified: '獲取教育證明',
  notice: {
    expired: {
      summary: {
        line1: '您仍然可以訪問和使用 白泽智能体平台。',
