const translation = {
  ...
  account: {
    ...
    langGeniusAccount: 'حساب AgentFlow',
    langGeniusAccountTip: 'حساب AgentFlow شما و داده‌های کاربری مرتبط.',
    editName: 'ویرایش نام',
  ...
  members: {
    ...
    invitationSentTip: 'دعوت‌نامه ارسال شد و آنها می‌توانند وارد AgentFlow شوند تا به داده‌های تیم شما دسترسی پیدا کنند.',
  ...
  provider: {
    ...
    openaiHosted: {
      ...
      desc: 'سرویس میزبانی OpenAI ارائه شده توسط AgentFlow به شما اجازه می‌دهد از مدل‌هایی مانند GPT-3.5 استفاده کنید. قبل از اتمام سهمیه آزمایشی خود، باید سایر ارائه‌دهندگان مدل را تنظیم کنید.',
  ...
  apiBasedExtension: {
    title: 'افزونه‌های مبتنی بر API مدیریت متمرکز API را فراهم می‌کنند و پیکربندی را برای استفاده آسان در برنامه‌های AgentFlow ساده می‌کنند.',
  ...
  about: {
    ...
    nowAvailable: 'AgentFlow {{version}} اکنون در دسترس است.',
    latestAvailable: 'AgentFlow {{version}} آخرین نسخه در دسترس است.',
  },
  appMenus: {
    overview: 'نظارت',
