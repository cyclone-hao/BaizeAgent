const translation = {
  ...
  account: {
    ...
    langGeniusAccount: 'حساب 白泽智能体平台',
    langGeniusAccountTip: 'حساب 白泽智能体平台 شما و داده‌های کاربری مرتبط.',
    editName: 'ویرایش نام',
  ...
  members: {
    ...
    invitationSentTip: 'دعوت‌نامه ارسال شد و آنها می‌توانند وارد 白泽智能体平台 شوند تا به داده‌های تیم شما دسترسی پیدا کنند.',
  ...
  provider: {
    ...
    openaiHosted: {
      ...
      desc: 'سرویس میزبانی OpenAI ارائه شده توسط 白泽智能体平台 به شما اجازه می‌دهد از مدل‌هایی مانند GPT-3.5 استفاده کنید. قبل از اتمام سهمیه آزمایشی خود، باید سایر ارائه‌دهندگان مدل را تنظیم کنید.',
  ...
  apiBasedExtension: {
    title: 'افزونه‌های مبتنی بر API مدیریت متمرکز API را فراهم می‌کنند و پیکربندی را برای استفاده آسان در برنامه‌های 白泽智能体平台 ساده می‌کنند.',
  ...
  about: {
    ...
    nowAvailable: '白泽智能体平台 {{version}} اکنون در دسترس است.',
    latestAvailable: '白泽智能体平台 {{version}} آخرین نسخه در دسترس است.',
  },
  appMenus: {
    overview: 'نظارت',
