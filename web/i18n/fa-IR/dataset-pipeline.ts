const translation = {
  ...
  knowledgeDescriptionPlaceholder: 'آنچه در این پایگاه دانش وجود دارد را شرح دهید. توضیحات دقیق به هوش مصنوعی اجازه می دهد تا با دقت بیشتری به محتوای مجموعه داده دسترسی داشته باشد. اگر خالی باشد، AgentFlow از استراتژی ضربه پیش فرض استفاده می کند. (اختیاری)',
}
