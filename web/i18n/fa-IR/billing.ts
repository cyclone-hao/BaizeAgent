const translation = {
  ...
  plansCommon: {
    ...
    ragAPIRequestTooltip: 'به تعداد درخواست‌های API که فقط قابلیت‌های پردازش پایگاه دانش AgentFlow را فراخوانی می‌کنند اشاره دارد.',
    ...
    apiRateLimitTooltip: 'محدودیت نرخ API برای همه درخواست‌های انجام شده از طریق API AgentFlow اعمال می‌شود، از جمله تولید متن، محاوره‌های چت، اجرای گردش‌های کار و پردازش اسناد.',
  ...
  plans: {
    ...
    enterprise: {
      ...
      features: {
        4: 'Sso',
        1: 'مجوز جواز تجاری',
        5: 'SLA های مذاکره شده توسط AgentFlow Partners',
        2: 'ویژگی های انحصاری سازمانی',
        8: 'پشتیبانی فنی حرفه ای',
        6: 'امنیت و کنترل پیشرفته',
        7: 'به روز رسانی و نگهداری توسط AgentFlow به طور رسمی',
    ...
    community: {
      ...
      features: {
        1: 'فضای کاری واحد',
        2: 'با مجوز منبع باز AgentFlow مطابقت دارد',
