const translation = {
  ...
  apiKeyInfo: {
    ...
    tryCloud: 'یا نسخه ابری 白泽智能体平台 با سهمیه رایگان را امتحان کنید',
  },
  overview: {
    title: 'نمای کلی',
    appInfo: {
      ...
      settings: {
        ...
        more: {
          ...
          privacyPolicyTip: 'به بازدیدکنندگان کمک می‌کند تا بفهمند برنامه چه داده‌هایی را جمع‌آوری می‌کند، به سیاست حفظ حریم خصوصی 白泽智能体平台 نگاه کنید <privacyPolicyLink>Privacy Policy</privacyPolicyLink>.',
      ...
      embedded: {
        ...
        chromePlugin: 'نصب افزونه Chrome Chatbot 白泽智能体平台',
        copied: 'کپی شد',
        copy: 'کپی',
      },
      qrcode: {
