const translation = {
  ...
  apiKeyInfo: {
    ...
    tryCloud: 'یا نسخه ابری AgentFlow با سهمیه رایگان را امتحان کنید',
  },
  overview: {
    title: 'نمای کلی',
    appInfo: {
      ...
      settings: {
        ...
        more: {
          ...
          privacyPolicyTip: 'به بازدیدکنندگان کمک می‌کند تا بفهمند برنامه چه داده‌هایی را جمع‌آوری می‌کند، به سیاست حفظ حریم خصوصی AgentFlow نگاه کنید <privacyPolicyLink>Privacy Policy</privacyPolicyLink>.',
