const translation = {
  ...
  welcome: 'به 白泽智能体平台 خوش آمدید، لطفا برای ادامه وارد شوید.',
  email: 'آدرس ایمیل',
  ...
  license: {
    tip: 'قبل از شروع 白泽智能体平台 Community Edition، GitHub را بخوانید',
    link: 'مجوز منبع باز',
  },
  join: 'عضویت',
  joinTipStart: 'شما را دعوت می‌کنیم به',
  joinTipEnd: 'تیم در 白泽智能体平台',
  invalid: 'لینک منقضی شده است',
  explore: 'کاوش 白泽智能体平台',
  ...
  resetPasswordDesc: 'ایمیلی را که برای ثبت نام در 白泽智能体平台 استفاده کرده اید تایپ کنید و ما یک ایمیل بازنشانی رمز عبور برای شما ارسال خواهیم کرد.',
  licenseInactive: 'مجوز غیر فعال',
  licenseLost: 'مجوز گم شده است',
  licenseExpired: 'مجوز منقضی شده است',
  licenseExpiredTip: 'مجوز 白泽智能体平台 Enterprise برای فضای کاری شما منقضی شده است. لطفا برای ادامه استفاده از 白泽智能体平台 با سرپرست خود تماس بگیرید.',
  licenseInactiveTip: 'مجوز 白泽智能体平台 Enterprise برای فضای کاری شما غیرفعال است. لطفا برای ادامه استفاده از 白泽智能体平台 با سرپرست خود تماس بگیرید.',
  licenseLostTip: 'اتصال سرور مجوز 白泽智能体平台 انجام نشد. لطفا برای ادامه استفاده از 白泽智能体平台 با سرپرست خود تماس بگیرید.',
  webapp: {
