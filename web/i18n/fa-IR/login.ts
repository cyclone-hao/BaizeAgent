const translation = {
  ...
  welcome: 'به AgentFlow خوش آمدید، لطفا برای ادامه وارد شوید.',
  email: 'آدرس ایمیل',
  ...
  license: {
    tip: 'قبل از شروع AgentFlow Community Edition، GitHub را بخوانید',
    link: 'مجوز منبع باز',
  },
  join: 'عضویت',
  joinTipStart: 'شما را دعوت می‌کنیم به',
  joinTipEnd: 'تیم در AgentFlow',
  invalid: 'لینک منقضی شده است',
  explore: 'کاوش AgentFlow',
  ...
  resetPasswordDesc: 'ایمیلی را که برای ثبت نام در AgentFlow استفاده کرده اید تایپ کنید و ما یک ایمیل بازنشانی رمز عبور برای شما ارسال خواهیم کرد.',
  licenseInactive: 'مجوز غیر فعال',
  licenseLost: 'مجوز گم شده است',
  licenseExpired: 'مجوز منقضی شده است',
  licenseExpiredTip: 'مجوز AgentFlow Enterprise برای فضای کاری شما منقضی شده است. لطفا برای ادامه استفاده از AgentFlow با سرپرست خود تماس بگیرید.',
  licenseInactiveTip: 'مجوز AgentFlow Enterprise برای فضای کاری شما غیرفعال است. لطفا برای ادامه استفاده از AgentFlow با سرپرست خود تماس بگیرید.',
  licenseLostTip: 'اتصال سرور مجوز AgentFlow انجام نشد. لطفا برای ادامه استفاده از AgentFlow با سرپرست خود تماس بگیرید.',
  webapp: {
