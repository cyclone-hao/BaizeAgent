const translation = {
  ...
  rejectContent: 'متاسفانه، شما واجد شرایط وضعیت تأیید شده آموزشی نیستید و به همین دلیل نمی‌توانید کوپن انحصاری ۱۰۰٪ برای طرح حرفه‌ای AgentFlow را در صورت استفاده از این آدرس ایمیل دریافت کنید.',
  learn: 'یاد بگیرید چگونه مدارک تحصیلی خود را تأیید کنید',
  successContent: 'ما یک کوپن تخفیف ۱۰۰٪ برای طرح حرفه‌ای AgentFlow به حساب شما صادر کرده‌ایم. این کوپن به مدت یک سال اعتبار دارد، لطفاً در بازه اعتبار از آن استفاده کنید.',
