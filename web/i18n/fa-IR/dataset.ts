const translation = {
  ...
  intro1: 'دانش می‌تواند در برنامه 白泽智能体平台 ',
  ...
  externalAPIPanelDescription: 'API دانش خارجی برای اتصال به یک پایگاه دانش خارج از 白泽智能体平台 و بازیابی دانش از آن پایگاه دانش استفاده می شود.',
