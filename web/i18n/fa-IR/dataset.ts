const translation = {
  ...
  intro1: 'دانش می‌تواند در برنامه AgentFlow ',
  ...
  externalAPIPanelDescription: 'API دانش خارجی برای اتصال به یک پایگاه دانش خارج از AgentFlow و بازیابی دانش از آن پایگاه دانش استفاده می شود.',
