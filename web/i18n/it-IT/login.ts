const translation = {
  ...
  welcome: 'Benvenuto su AgentFlow, per favore accedi per continuare.',
  ...
  license: {
    tip: 'Prima di avviare AgentFlow Community Edition, leggi su GitHub',
    link: 'Licenza open-source',
  },
  join: 'Unisciti',
  joinTipStart: 'Invitato a unirti al',
  joinTipEnd: 'team su AgentFlow',
  invalid: 'Il link è scaduto',
  explore: 'Esplora AgentFlow',
  ...
  resetPasswordDesc: 'Digita l\'e-mail che hai utilizzato per registrarti su AgentFlow e ti invieremo un\'e-mail per reimpostare la password.',
  ...
  licenseLostTip: 'Impossibile connettersi al server licenze AgentFlow. Contatta il tuo amministratore per continuare a utilizzare AgentFlow.',
  licenseExpired: 'Licenza scaduta',
  licenseLost: 'Licenza persa',
  licenseExpiredTip: 'La licenza AgentFlow Enterprise per la tua area di lavoro è scaduta. Contatta il tuo amministratore per continuare a utilizzare AgentFlow.',
  licenseInactiveTip: 'La licenza AgentFlow Enterprise per la tua area di lavoro è inattiva. Contatta il tuo amministratore per continuare a utilizzare AgentFlow.',
