const translation = {
  ...
  welcome: 'Benvenuto su 白泽智能体平台, per favore accedi per continuare.',
  ...
  license: {
    tip: 'Prima di avviare 白泽智能体平台 Community Edition, leggi su GitHub',
    link: 'Licenza open-source',
  },
  join: 'Unisciti',
  joinTipStart: 'Invitato a unirti al',
  joinTipEnd: 'team su 白泽智能体平台',
  invalid: 'Il link è scaduto',
  explore: 'Esplora 白泽智能体平台',
  ...
  resetPasswordDesc: 'Digita l\'e-mail che hai utilizzato per registrarti su 白泽智能体平台 e ti invieremo un\'e-mail per reimpostare la password.',
  ...
  licenseLostTip: 'Impossibile connettersi al server licenze 白泽智能体平台. Contatta il tuo amministratore per continuare a utilizzare 白泽智能体平台.',
  licenseExpired: 'Licenza scaduta',
  licenseLost: 'Licenza persa',
  licenseExpiredTip: 'La licenza 白泽智能体平台 Enterprise per la tua area di lavoro è scaduta. Contatta il tuo amministratore per continuare a utilizzare 白泽智能体平台.',
  licenseInactiveTip: 'La licenza 白泽智能体平台 Enterprise per la tua area di lavoro è inattiva. Contatta il tuo amministratore per continuare a utilizzare 白泽智能体平台.',
