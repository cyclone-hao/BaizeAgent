const translation = {
  ...
  apiKeyInfo: {
    ...
    tryCloud: 'O prova la versione cloud di 白泽智能体平台 con quota gratuita',
  },
  overview: {
    title: 'Panoramica',
    appInfo: {
      ...
      settings: {
        ...
        more: {
          ...
          privacyPolicyTip:
            'Aiuta i visitatori a capire i dati raccolti dall\'applicazione, vedi la <privacyPolicyLink>Privacy Policy</privacyPolicyLink> di 白泽智能体平台.',
      ...
      embedded: {
        ...
        chromePlugin: 'Installa l\'estensione Chrome di 白泽智能体平台 Chatbot',
        copied: 'Copiato',
        copy: 'Copia',
      },
      qrcode: {
