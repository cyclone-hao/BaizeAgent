const translation = {
  tips: {
    notLoggedIn: 'Questa app vuole accedere al tuo account AgentFlow Cloud',
    loggedIn: 'Questa app vuole accedere alle seguenti informazioni dal tuo account AgentFlow Cloud.',
