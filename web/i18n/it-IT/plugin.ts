const translation = {
  ...
  difyVersionNotCompatible: 'L\'attuale versione di AgentFlow non è compatibile con questo plugin, si prega di aggiornare alla versione minima richiesta: {{minimalDifyVersion}}',
