const translation = {
  ...
  license: {
    tip: 'GitHub のオープンソースライセンスを確認してから、白泽智能体平台 Community Edition を開始してください。',
    link: 'オープンソースライセンス',
  },
  join: '参加する',
  ...
  resetPasswordDesc: '白泽智能体平台 へのサインアップに使用したメールアドレスを入力すると、パスワードリセットメールが送信されます。',
  licenseLost: 'ライセンスを失った',
  licenseExpiredTip: 'ワークスペースの 白泽智能体平台 Enterprise ライセンスの有効期限が切れています。白泽智能体平台 を引き続き使用するには、管理者に連絡してください。',
  licenseInactive: 'ライセンスが非アクティブです',
  licenseInactiveTip: 'ワークスペースの 白泽智能体平台 Enterprise ライセンスが非アクティブです。白泽智能体平台 を引き続き使用するには、管理者に連絡してください。',
  licenseExpired: 'ライセンスの有効期限が切れています',
  licenseLostTip: '白泽智能体平台 ライセンスサーバーへの接続に失敗しました。続けて 白泽智能体平台 を使用するために管理者に連絡してください。',
  webapp: {
    login: 'ログイン',
