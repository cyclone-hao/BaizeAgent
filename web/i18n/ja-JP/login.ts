const translation = {
  ...
  license: {
    tip: 'GitHub のオープンソースライセンスを確認してから、AgentFlow Community Edition を開始してください。',
    link: 'オープンソースライセンス',
  },
  join: '参加する',
  ...
  resetPasswordDesc: 'AgentFlow へのサインアップに使用したメールアドレスを入力すると、パスワードリセットメールが送信されます。',
  licenseLost: 'ライセンスを失った',
  licenseExpiredTip: 'ワークスペースの AgentFlow Enterprise ライセンスの有効期限が切れています。AgentFlow を引き続き使用するには、管理者に連絡してください。',
  licenseInactive: 'ライセンスが非アクティブです',
  licenseInactiveTip: 'ワークスペースの AgentFlow Enterprise ライセンスが非アクティブです。AgentFlow を引き続き使用するには、管理者に連絡してください。',
  licenseExpired: 'ライセンスの有効期限が切れています',
  licenseLostTip: 'AgentFlow ライセンスサーバーへの接続に失敗しました。続けて AgentFlow を使用するために管理者に連絡してください。',
  webapp: {
    login: 'ログイン',
