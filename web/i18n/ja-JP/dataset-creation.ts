const translation = {
  ...
  otherDataSource: {
    ...
    description: '現在、AgentFlow のナレッジベースには利用できるデータソースが限られています。AgentFlow のナレッジベースにデータソースを提供いただくことは、プラットフォームの柔軟性と能力を向上させる上で非常に有益です。貢献ガイドをご用意していますので、ぜひご協力ください。詳細については、以下のリンクをクリックしてください。',
    learnMore: '詳細はこちら',
  },
  watercrawl: {
