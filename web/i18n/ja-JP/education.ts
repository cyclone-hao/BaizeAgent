const translation = {
  toVerified: '教育認証を取得',
  toVerifiedTip: {
    front: '現在、教育認証ステータスを取得する資格があります。以下に教育情報を入力し、認証プロセスを完了すると、AgentFlow プロフェッショナルプランの',
    coupon: '100％割引クーポン',
    end: 'を受け取ることができます。',
  },
  ...
  form: {
    ...
    terms: {
      ...
      option: {
        ...
        inSchool: '提供した教育機関に在籍または勤務している ことを確認します。AgentFlow は在籍/雇用証明の提出を求める場合があります。不正な情報を申告した場合、教育認証に基づき免除された費用を支払うことに同意します。',
      },
    },
  },
  submit: '送信',
  ...
  learn: '教育認証の取得方法はこちら',
  successTitle: 'AgentFlow 教育認証を取得しました！',
  successContent: 'お客様のアカウントに AgentFlow プロフェッショナルプランの 100% 割引クーポン を発行しました。有効期間は 1 年間 ですので、期限内にご利用ください。',
  rejectTitle: 'AgentFlow 教育認証が拒否されました',
  rejectContent: '申し訳ございませんが、このメールアドレスでは 教育認証 の資格を取得できず、AgentFlow プロフェッショナルプランの 100％割引クーポン を受け取ることはできません。',
  ...
  notice: {
    ...
    expired: {
      ...
      summary: {
        line1: 'AgentFlow は引き続きご利用いただけますが、新しい教育割引クーポンの対象外となります。',
        line2: '',
      },
    },
    isAboutToExpire: {
