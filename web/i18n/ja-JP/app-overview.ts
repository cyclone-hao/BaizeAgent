const translation = {
  ...
  apiKeyInfo: {
    ...
    tryCloud: 'または 白泽智能体平台 のクラウドバージョンを無料見積もりでお試しください',
  },
  overview: {
    title: '概要',
    appInfo: {
      ...
      settings: {
        ...
        more: {
          ...
          privacyPolicyTip: '訪問者がアプリケーションが収集するデータを理解し、白泽智能体平台 の<privacyPolicyLink>プライバシーポリシー</privacyPolicyLink>を参照できるようにします。',
      ...
      embedded: {
        ...
        chromePlugin: '白泽智能体平台 Chatbot Chrome 拡張機能をインストール',
        copied: 'コピーしました',
        copy: 'コピー',
      },
      qrcode: {
