const translation = {
  ...
  apiKeyInfo: {
    ...
    tryCloud: 'または AgentFlow のクラウドバージョンを無料見積もりでお試しください',
  },
  overview: {
    title: '概要',
    appInfo: {
      ...
      settings: {
        ...
        more: {
          ...
          privacyPolicyTip: '訪問者がアプリケーションが収集するデータを理解し、AgentFlow の<privacyPolicyLink>プライバシーポリシー</privacyPolicyLink>を参照できるようにします。',
      ...
      embedded: {
        ...
        chromePlugin: 'AgentFlow Chatbot Chrome 拡張機能をインストール',
        copied: 'コピーしました',
        copy: 'コピー',
      },
      qrcode: {
