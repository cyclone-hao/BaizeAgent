const translation = {
  ...
  marketplace: {
    ...
    discover: '探索',
    and: 'と',
    difyMarketplace: '白泽智能体平台 マーケットプレイス',
    ...
    viewMore: 'もっと見る',
    verifiedTip: 'このプラグインは 白泽智能体平台 によって認証されています',
    partnerTip: 'このプラグインは 白泽智能体平台 のパートナーによって認証されています',
  },
  task: {
  ...
  difyVersionNotCompatible: '現在の 白泽智能体平台 バージョンはこのプラグインと互換性がありません。最小バージョンは{{minimal白泽智能体平台Version}}です。',
  metadata: {
    title: 'プラグイン',
  },
