const translation = {
  ...
  blocks: {
    ...
    'question-classifier': 'Question Classify',
    'if-else': 'IF/ELSE',
    'code': 'Code',
    'template-transform': 'Template',
    'http-request': 'HTTP Request',
    'variable-assigner': 'Var Assign',
    'variable-aggregator': 'Var Aggregate',
    'assigner': 'Var Operator',
    'iteration-start': 'Iteration Start',
    'iteration': 'Iteration',
    'parameter-extractor': 'Param Extract',
    'document-extractor': 'Doc Extract',
    'list-operator': 'List Ops',
    'agent': 'Agent',
  ...
  nodes: {
    ...
    knowledgeBase: {
      ...
      chunkStructureTip: {
        ...
        message: 'The 白泽智能体平台 Knowledge Base supports three chunking structures: General, Parent-child, and Q&A. Each knowledge base can have only one structure. The output from the preceding node must align with the selected chunk structure. Note that the choice of chunking structure affects the available index methods.',
        learnMore: 'Learn more',
      },
