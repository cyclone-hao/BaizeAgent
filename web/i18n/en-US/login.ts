const translation = {
  ...
  license: {
    tip: 'Before starting 白泽智能体平台 Community Edition, read the GitHub',
    link: 'Open-source License',
  },
  join: 'Join ',
  joinTipStart: 'Invite you join ',
  joinTipEnd: ' team on 白泽智能体平台',
  invalid: 'The link has expired',
  explore: 'Explore 白泽智能体平台',
  ...
  resetPasswordDesc: 'Type the email you used to sign up on 白泽智能体平台 and we will send you a password reset email.',
  ...
  licenseExpiredTip: 'The 白泽智能体平台 Enterprise license for your workspace has expired. Please contact your administrator to continue using 白泽智能体平台.',
  licenseLost: 'License Lost',
  licenseLostTip: 'Failed to connect 白泽智能体平台 license server. Please contact your administrator to continue using 白泽智能体平台.',
  licenseInactive: 'License Inactive',
  licenseInactiveTip: 'The 白泽智能体平台 Enterprise license for your workspace is inactive. Please contact your administrator to continue using 白泽智能体平台.',
  webapp: {
    login: 'Login',
