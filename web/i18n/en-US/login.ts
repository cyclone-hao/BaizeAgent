const translation = {
  ...
  license: {
    tip: 'Before starting AgentFlow Community Edition, read the GitHub',
    link: 'Open-source License',
  },
  join: 'Join ',
  joinTipStart: 'Invite you join ',
  joinTipEnd: ' team on AgentFlow',
  invalid: 'The link has expired',
  explore: 'Explore AgentFlow',
  ...
  resetPasswordDesc: 'Type the email you used to sign up on AgentFlow and we will send you a password reset email.',
  ...
  licenseExpiredTip: 'The AgentFlow Enterprise license for your workspace has expired. Please contact your administrator to continue using AgentFlow.',
  licenseLost: 'License Lost',
  licenseLostTip: 'Failed to connect AgentFlow license server. Please contact your administrator to continue using AgentFlow.',
  licenseInactive: 'License Inactive',
  licenseInactiveTip: 'The AgentFlow Enterprise license for your workspace is inactive. Please contact your administrator to continue using AgentFlow.',
  webapp: {
    login: 'Login',
