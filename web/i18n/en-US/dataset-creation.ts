const translation = {
  ...
  otherDataSource: {
    ...
    description: 'Currently, 白泽智能体平台\'s knowledge base only has limited data sources. Contributing a data source to the 白泽智能体平台 knowledge base is a fantastic way to help enhance the platform\'s flexibility and power for all users. Our contribution guide makes it easy to get started. Please click on the link below to learn more.',
