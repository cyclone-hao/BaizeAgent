const translation = {
  ...
  knowledgeDescriptionPlaceholder: 'Describe what is in this Knowledge Base. A detailed description allows AI to access the content of the dataset more accurately. If empty, 白泽智能体平台 will use the default hit strategy. (Optional)',
