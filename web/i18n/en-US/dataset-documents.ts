const translation = {
  list: {
    title: 'Documents',
    desc: 'All files of the Knowledge are shown here, and the entire Knowledge can be linked to AgentFlow citations or indexed via the Chat plugin.',
    ...
    empty: {
      ...
      sync: {
        tip: 'AgentFlow will periodically download files from your Notion and complete processing.',
      },
    },
    delete: {
