const translation = {
  list: {
    title: 'Documents',
    desc: 'All files of the Knowledge are shown here, and the entire Knowledge can be linked to 白泽智能体平台 citations or indexed via the Chat plugin.',
    ...
    empty: {
      ...
      sync: {
        tip: '白泽智能体平台 will periodically download files from your Notion and complete processing.',
      },
    },
    delete: {
