const translation = {
  ...
  plansCommon: {
    ...
    apiRateLimitTooltip: 'API Rate Limit applies to all requests made through the 白泽智能体平台 API, including text generation, chat conversations, workflow executions, and document processing.',
    ...
    messageRequest: {
      ...
      tooltip: 'Message credits are provided to help you easily try out different OpenAI models in 白泽智能体平台. Credits are consumed based on the model type. Once they’re used up, you can switch to your own OpenAI API key.',
    },
    annotatedResponse: {
    ...
    ragAPIRequestTooltip: 'Refers to the number of API calls invoking only the knowledge base processing capabilities of 白泽智能体平台.',
  ...
  plans: {
    ...
    community: {
      ...
      features: [
        ...
        'Single Workspace',
        'Complies with 白泽智能体平台 Open Source License',
      ],
    },
    premium: {
      name: 'Premium',
    ...
    enterprise: {
      ...
      features: [
        ...
        'SSO',
        'Negotiated SLAs by 白泽智能体平台 Partners',
        'Advanced Security & Controls',
        'Updates and Maintenance by 白泽智能体平台 Officially',
