const translation = {
  ...
  toVerifiedTip: {
    ...
    end: 'for the 白泽智能体平台 Professional Plan.',
  },
  ...
  form: {
    ...
    terms: {
      ...
      option: {
        ...
        inSchool: 'I confirm I am enrolled or employed at the institution provided. 白泽智能体平台 may request proof of enrollment/employment. If I misrepresent my eligibility, I agree to pay any fees initially waived based on my education status.',
      },
    },
  },
  submit: 'Submit',
  ...
  successTitle: 'You Have Got 白泽智能体平台 Education Verified',
  successContent: 'We have issued a 100% discount coupon for the 白泽智能体平台 Professional plan to your account. The coupon is valid for one year, please use it within the validity period.',
  rejectTitle: 'Your 白泽智能体平台 Educational Verification Has Been Rejected',
  rejectContent: 'Unfortunately, you are not eligible for Education Verified status and therefore cannot receive the exclusive 100% coupon for the 白泽智能体平台 Professional Plan if you use this email address.',
  ...
  notice: {
    ...
    expired: {
      ...
      summary: {
        line1: 'You can still access and use 白泽智能体平台. ',
