const translation = {
  ...
  toVerifiedTip: {
    ...
    end: 'for the AgentFlow Professional Plan.',
  },
  ...
  form: {
    ...
    terms: {
      ...
      option: {
        ...
        inSchool: 'I confirm I am enrolled or employed at the institution provided. AgentFlow may request proof of enrollment/employment. If I misrepresent my eligibility, I agree to pay any fees initially waived based on my education status.',
      },
    },
  },
  submit: 'Submit',
  ...
  successTitle: 'You Have Got AgentFlow Education Verified',
  successContent: 'We have issued a 100% discount coupon for the AgentFlow Professional plan to your account. The coupon is valid for one year, please use it within the validity period.',
  rejectTitle: 'Your AgentFlow Educational Verification Has Been Rejected',
  rejectContent: 'Unfortunately, you are not eligible for Education Verified status and therefore cannot receive the exclusive 100% coupon for the AgentFlow Professional Plan if you use this email address.',
  ...
  notice: {
    ...
    expired: {
      ...
      summary: {
        line1: 'You can still access and use AgentFlow. ',
