const translation = {
  ...
  form: {
    ...
    descPlaceholder: 'Describe what is in this data set. A detailed description allows AI to access the content of the data set in a timely manner. If empty, AgentFlow will use the default hit strategy.',
