const translation = {
  ...
  form: {
    ...
    descPlaceholder: 'Bu Bilginin içeriğini açıklayın. Ayrıntılı bir açıklama, AI\'nın Bilginin içeriğine zamanında erişmesini sağlar. Boş bırakılırsa, AgentFlow varsayılan isabet stratejisini kullanır.',
