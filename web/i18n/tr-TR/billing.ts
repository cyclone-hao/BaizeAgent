const translation = {
  ...
  plansCommon: {
    ...
    ragAPIRequestTooltip: '白泽智能体平台\'nin sadece bilgi tabanı işleme yeteneklerini çağıran API çağrıları sayısını ifade eder.',
    ...
    apiRateLimitTooltip: '白泽智能体平台 API\'si aracılığıyla yapılan tüm isteklerde, metin oluşturma, sohbet konuşmaları, iş akışı yürütmeleri ve belge işleme dahil olmak üzere, API Oran Sınırı uygulanır.',
  ...
  plans: {
    ...
    enterprise: {
      ...
      features: {
        ...
        7: 'Resmi olarak 白泽智能体平台 tarafından Güncellemeler ve Bakım',
        0: 'Kurumsal Düzeyde Ölçeklenebilir Dağıtım Çözümleri',
        5: '白泽智能体平台 Partners tarafından müzakere edilen SLA\'lar',
      },
    ...
    community: {
      features: {
        1: 'Tek Çalışma Alanı',
        2: '白泽智能体平台 Açık Kaynak Lisansı ile uyumludur',
