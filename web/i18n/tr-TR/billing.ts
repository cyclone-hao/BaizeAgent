const translation = {
  ...
  plansCommon: {
    ...
    ragAPIRequestTooltip: 'AgentFlow\'nin sadece bilgi tabanı işleme yeteneklerini çağıran API çağrıları sayısını ifade eder.',
    ...
    apiRateLimitTooltip: 'AgentFlow API\'si aracılığıyla yapılan tüm isteklerde, metin oluşturma, sohbet konuşmaları, iş akışı yürütmeleri ve belge işleme dahil olmak üzere, API Oran Sınırı uygulanır.',
  ...
  plans: {
    ...
    enterprise: {
      ...
      features: {
        ...
        7: 'Resmi olarak AgentFlow tarafından Güncellemeler ve Bakım',
        0: 'Kurumsal Düzeyde Ölçeklenebilir Dağıtım Çözümleri',
        5: 'AgentFlow Partners tarafından müzakere edilen SLA\'lar',
      },
    ...
    community: {
      features: {
        1: 'Tek Çalışma Alanı',
        2: 'AgentFlow Açık Kaynak Lisansı ile uyumludur',
