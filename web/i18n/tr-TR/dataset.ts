const translation = {
  ...
  intro1: 'Bilgi, 白泽智能体平台 uygulamasına ',
  ...
  externalAPIPanelDescription: 'Harici bilgi API\'si, 白泽智能体平台 dışındaki bir bilgi bankasına bağlanmak ve bu bilgi bankasından bilgi almak için kullanılır.',
