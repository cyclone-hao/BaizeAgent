const translation = {
  ...
  intro1: 'Bilgi, AgentFlow uygulamasına ',
  ...
  externalAPIPanelDescription: 'Harici bilgi API\'si, AgentFlow dışındaki bir bilgi bankasına bağlanmak ve bu bilgi bankasından bilgi almak için kullanılır.',
