const translation = {
  ...
  welcome: 'AgentFlow\'ye hoş geldiniz, devam etmek için lütfen giriş yapın.',
  ...
  license: {
    tip: 'AgentFlow Community Edition\'ı başlatmadan önce GitHub\'daki',
  ...
  resetPasswordDesc: 'AgentFlow\'a kaydolmak için kullandığınız e-postayı yazın, size bir şifre sıfırlama e-postası gönderelim.',
  ...
  back: 'Geri',
  licenseExpiredTip: 'Çalışma alanınız için AgentFlow Enterprise lisansının süresi doldu. AgentFlow\'ı kullanmaya devam etmek için lütfen yöneticinizle iletişime geçin.',
  licenseLostTip: 'AgentFlow lisans sunucusuna bağlanılamadı. AgentFlow\'ı kullanmaya devam etmek için lütfen yöneticinizle iletişime geçin.',
  licenseInactiveTip: 'Çalışma alanınız için AgentFlow Enterprise lisansı etkin değil. AgentFlow\'ı kullanmaya devam etmek için lütfen yöneticinizle iletişime geçin.',
