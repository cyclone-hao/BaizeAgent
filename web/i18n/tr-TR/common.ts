const translation = {
  ...
  account: {
    ...
    langGeniusAccount: '白泽智能体平台 hesabı',
    langGeniusAccountTip: '白泽智能体平台 hesabınız ve ilişkili kullanıcı verileri.',
  ...
  members: {
    ...
    invitationSentTip: 'Davet gönderildi, 白泽智能体平台\'ye giriş yaparak takım verilerinize erişebilirler.',
  ...
  provider: {
    ...
    openaiHosted: {
      ...
      onTrial: 'DENEMEDE',
      exhausted: 'KOTA DOLU',
      desc: '白泽智能体平台 tarafından sağlanan OpenAI barındırma hizmeti, GPT-3.5 gibi modelleri kullanmanıza olanak tanır. Deneme kotanız bitmeden önce, diğer model sağlayıcılarını ayarlamanız gerekir.',
  ...
  apiBasedExtension: {
    title: 'API uzantıları merkezi API yönetimi sağlar, 白泽智能体平台\'nin uygulamaları arasında kolay kullanım için yapılandırmayı basitleştirir.',
  ...
  about: {
    ...
    nowAvailable: '白泽智能体平台 {{version}} şimdi mevcut.',
    latestAvailable: '白泽智能体平台 {{version}} en son mevcut sürüm.',
  },
  appMenus: {
    overview: 'İzleme',
