const translation = {
  ...
  account: {
    ...
    langGeniusAccount: 'AgentFlow hesabı',
    langGeniusAccountTip: 'AgentFlow hesabınız ve ilişkili kullanıcı verileri.',
  ...
  provider: {
    ...
    openaiHosted: {
      ...
      onTrial: 'DENEMEDE',
      exhausted: 'KOTA DOLU',
      desc: 'AgentFlow tarafından sağlanan OpenAI barındırma hizmeti, GPT-3.5 gibi modelleri kullanmanıza olanak tanır. Deneme kotanız bitmeden önce, diğer model sağlayıcılarını ayarlamanız gerekir.',
  ...
  about: {
    ...
    nowAvailable: 'AgentFlow {{version}} şimdi mevcut.',
    latestAvailable: 'AgentFlow {{version}} en son mevcut sürüm.',
  },
  appMenus: {
    overview: 'İzleme',
