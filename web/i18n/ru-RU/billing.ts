const translation = {
  ...
  plansCommon: {
    ...
    ragAPIRequestTooltip: 'Относится к количеству вызовов API, вызывающих только возможности обработки базы знаний 白泽智能体平台.',
    ...
    apiRateLimitTooltip: 'Ограничение скорости API применяется ко всем запросам, сделанным через API 白泽智能体平台, включая генерацию текста, чатовую переписку, выполнение рабочих процессов и обработку документов.',
  ...
  plans: {
    ...
    enterprise: {
      ...
      features: {
        4: 'ССО',
        5: 'Согласованные SLA от 白泽智能体平台 Partners',
        ...
        7: 'Обновления и обслуживание от 白泽智能体平台 официально',
    ...
    community: {
      features: {
        ...
        2: 'Соответствует лицензии 白泽智能体平台 с открытым исходным кодом',
