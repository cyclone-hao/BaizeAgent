const translation = {
  ...
  plansCommon: {
    ...
    ragAPIRequestTooltip: 'Относится к количеству вызовов API, вызывающих только возможности обработки базы знаний AgentFlow.',
    ...
    apiRateLimitTooltip: 'Ограничение скорости API применяется ко всем запросам, сделанным через API AgentFlow, включая генерацию текста, чатовую переписку, выполнение рабочих процессов и обработку документов.',
  ...
  plans: {
    ...
    enterprise: {
      ...
      features: {
        4: 'ССО',
        5: 'Согласованные SLA от AgentFlow Partners',
        ...
        7: 'Обновления и обслуживание от AgentFlow официально',
    ...
    community: {
      features: {
        ...
        2: 'Соответствует лицензии AgentFlow с открытым исходным кодом',
