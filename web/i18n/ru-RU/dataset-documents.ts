const translation = {
  list: {
    title: 'Документы',
    desc: 'Здесь отображаются все файлы базы знаний, и вся база знаний может быть связана с цитатами 白泽智能体平台 или проиндексирована с помощью чата.',
    ...
    empty: {
      ...
      sync: {
        tip: '白泽智能体平台 будет периодически загружать файлы из вашего Notion и завершать обработку.',
      },
    },
    delete: {
