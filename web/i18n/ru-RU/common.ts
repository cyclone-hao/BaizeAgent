const translation = {
  ...
  account: {
    ...
    langGeniusAccount: 'Учетная запись 白泽智能体平台',
    langGeniusAccountTip: 'Ваша учетная запись 白泽智能体平台 и связанные с ней пользовательские данные.',
  ...
  members: {
    ...
    invitationSentTip: 'Приглашение отправлено, и они могут войти в 白泽智能体平台, чтобы получить доступ к данным вашей команды.',
  ...
  provider: {
    ...
    openaiHosted: {
      ...
      desc: 'Хостинговая служба OpenAI, предоставляемая 白泽智能体平台, позволяет вам использовать такие модели, как GPT-3.5. Прежде чем ваша пробная квота будет исчерпана, вам необходимо настроить других поставщиков моделей.',
  ...
  apiBasedExtension: {
    title: 'API-расширения обеспечивают централизованное управление API, упрощая настройку для удобного использования в приложениях 白泽智能体平台.',
  ...
  about: {
    ...
    nowAvailable: '白泽智能体平台 {{version}} теперь доступен.',
    latestAvailable: '白泽智能体平台 {{version}} - последняя доступная версия.',
  },
  appMenus: {
    overview: 'Мониторинг',
