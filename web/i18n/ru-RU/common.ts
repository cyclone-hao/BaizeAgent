const translation = {
  ...
  account: {
    ...
    langGeniusAccount: 'Учетная запись AgentFlow',
    langGeniusAccountTip: 'Ваша учетная запись AgentFlow и связанные с ней пользовательские данные.',
  ...
  members: {
    ...
    invitationSentTip: 'Приглашение отправлено, и они могут войти в AgentFlow, чтобы получить доступ к данным вашей команды.',
  ...
  provider: {
    ...
    openaiHosted: {
      ...
      desc: 'Хостинговая служба OpenAI, предоставляемая AgentFlow, позволяет вам использовать такие модели, как GPT-3.5. Прежде чем ваша пробная квота будет исчерпана, вам необходимо настроить других поставщиков моделей.',
  ...
  apiBasedExtension: {
    title: 'API-расширения обеспечивают централизованное управление API, упрощая настройку для удобного использования в приложениях AgentFlow.',
  ...
  about: {
    ...
    nowAvailable: 'AgentFlow {{version}} теперь доступен.',
    latestAvailable: 'AgentFlow {{version}} - последняя доступная версия.',
  },
  appMenus: {
    overview: 'Мониторинг',
