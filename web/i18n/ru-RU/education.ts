const translation = {
  toVerifiedTip: {
    end: 'для профессионального плана 白泽智能体平台.',
  ...
  form: {
    ...
    terms: {
      ...
      option: {
        ...
        inSchool: 'Я подтверждаю, что я зачислен или работаю в указанной учреждении. 白泽智能体平台 может запросить подтверждение зачисления/трудоустройства. Если я неправильно укажу свою правообладанность, я согласен оплатить любые сборы, которые изначально были отменены на основании моего образовательного статуса.',
      },
      title: 'Условия и соглашения',
    },
  },
  submit: 'Отправить',
  rejectTitle: 'Ваша образовательная проверка 白泽智能体平台 была отклонена',
  ...
  successTitle: 'Вы получили подтвержденное образование 白泽智能体平台',
  emailLabel: 'Ваш текущий адрес электронной почты',
  rejectContent: 'К сожалению, вы не имеете права на статус Проверенного образованием и, следовательно, не можете получить эксклюзивный купон на 100% для профессионального плана 白泽智能体平台, если вы используете этот адрес электронной почты.',
  successContent: 'Мы выдали купон на 100% скидку на план 白泽智能体平台 Professional для вашего аккаунта. Купон действителен в течение одного года, пожалуйста, используйте его в течение срока действия.',
  notice: {
    expired: {
      summary: {
        line1: 'Вы все еще можете получить доступ к 白泽智能体平台 и использовать его.',
