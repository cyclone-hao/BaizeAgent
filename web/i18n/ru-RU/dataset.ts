const translation = {
  ...
  intro1: 'Базу знаний можно интегрировать в приложение 白泽智能体平台 ',
  ...
  externalAPIPanelDescription: 'Внешний API базы знаний используется для подключения к базе знаний за пределами 白泽智能体平台 и извлечения знаний из этой базы знаний.',
  chunkingMode: {
    general: 'Общее',
