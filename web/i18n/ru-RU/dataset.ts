const translation = {
  ...
  intro1: 'Базу знаний можно интегрировать в приложение AgentFlow ',
  ...
  externalAPIPanelDescription: 'Внешний API базы знаний используется для подключения к базе знаний за пределами AgentFlow и извлечения знаний из этой базы знаний.',
  chunkingMode: {
    general: 'Общее',
