const translation = {
  ...
  apiKeyInfo: {
    ...
    tryCloud: 'Или попробуйте облачную версию AgentFlow с бесплатной квотой',
  },
  overview: {
    title: 'Обзор',
    appInfo: {
      ...
      settings: {
        ...
        more: {
          ...
          privacyPolicyTip: 'Помогает посетителям понять, какие данные собирает приложение, см. <privacyPolicyLink>Политику конфиденциальности</privacyPolicyLink> AgentFlow.',
      ...
      embedded: {
        ...
        chromePlugin: 'Установите расширение AgentFlow Chatbot для Chrome',
        copied: 'Скопировано',
        copy: 'Копировать',
      },
      qrcode: {
