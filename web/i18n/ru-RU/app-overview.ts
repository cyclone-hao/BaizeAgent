const translation = {
  ...
  apiKeyInfo: {
    ...
    tryCloud: 'Или попробуйте облачную версию 白泽智能体平台 с бесплатной квотой',
  },
  overview: {
    title: 'Обзор',
    appInfo: {
      ...
      settings: {
        ...
        more: {
          ...
          privacyPolicyTip: 'Помогает посетителям понять, какие данные собирает приложение, см. <privacyPolicyLink>Политику конфиденциальности</privacyPolicyLink> 白泽智能体平台.',
      ...
      embedded: {
        ...
        chromePlugin: 'Установите расширение 白泽智能体平台 Chatbot для Chrome',
        copied: 'Скопировано',
        copy: 'Копировать',
      },
      qrcode: {
