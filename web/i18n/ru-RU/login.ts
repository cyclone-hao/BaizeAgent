const translation = {
  ...
  welcome: 'Добро пожаловать в AgentFlow, пожалуйста, войдите, чтобы продолжить.',
  ...
  license: {
    tip: 'Перед запуском AgentFlow Community Edition ознакомьтесь с лицензией GitHub',
    link: 'Лицензия с открытым исходным кодом',
  },
  join: 'Присоединиться',
  joinTipStart: 'Приглашаем вас присоединиться к',
  joinTipEnd: 'команде на AgentFlow',
  invalid: 'Ссылка истекла',
  explore: 'Изучить AgentFlow',
  ...
  resetPasswordDesc: 'Введите адрес электронной почты, который вы использовали для регистрации в AgentFlow, и мы отправим вам электронное письмо для сброса пароля.',
  or: 'ИЛИ',
  licenseInactive: 'Лицензия неактивна',
  licenseLostTip: 'Не удалось подключить сервер лицензий AgentFlow. Обратитесь к своему администратору, чтобы продолжить использование AgentFlow.',
  licenseExpired: 'Срок действия лицензии истек',
  licenseLost: 'Утеряна лицензия',
  licenseInactiveTip: 'Лицензия AgentFlow Enterprise для рабочего пространства неактивна. Обратитесь к своему администратору, чтобы продолжить использование AgentFlow.',
  licenseExpiredTip: 'Срок действия лицензии AgentFlow Enterprise для рабочего пространства истек. Обратитесь к своему администратору, чтобы продолжить использование AgentFlow.',
  webapp: {
