const translation = {
  ...
  welcome: 'Добро пожаловать в 白泽智能体平台, пожалуйста, войдите, чтобы продолжить.',
  ...
  license: {
    tip: 'Перед запуском 白泽智能体平台 Community Edition ознакомьтесь с лицензией GitHub',
    link: 'Лицензия с открытым исходным кодом',
  },
  join: 'Присоединиться',
  joinTipStart: 'Приглашаем вас присоединиться к',
  joinTipEnd: 'команде на 白泽智能体平台',
  invalid: 'Ссылка истекла',
  explore: 'Изучить 白泽智能体平台',
  ...
  resetPasswordDesc: 'Введите адрес электронной почты, который вы использовали для регистрации в 白泽智能体平台, и мы отправим вам электронное письмо для сброса пароля.',
  or: 'ИЛИ',
  licenseInactive: 'Лицензия неактивна',
  licenseLostTip: 'Не удалось подключить сервер лицензий 白泽智能体平台. Обратитесь к своему администратору, чтобы продолжить использование 白泽智能体平台.',
  licenseExpired: 'Срок действия лицензии истек',
  licenseLost: 'Утеряна лицензия',
  licenseInactiveTip: 'Лицензия 白泽智能体平台 Enterprise для рабочего пространства неактивна. Обратитесь к своему администратору, чтобы продолжить использование 白泽智能体平台.',
  licenseExpiredTip: 'Срок действия лицензии 白泽智能体平台 Enterprise для рабочего пространства истек. Обратитесь к своему администратору, чтобы продолжить использование 白泽智能体平台.',
  webapp: {
