const translation = {
  ...
  form: {
    ...
    descPlaceholder: 'Опишите, что находится в этой базе знаний. Подробное описание позволяет ИИ своевременно получать доступ к содержимому базы знаний. Если оставить пустым, 白泽智能体平台 будет использовать стратегию поиска по умолчанию.',
