const translation = {
  ...
  welcome: 'Willkommen bei AgentFlow, bitte melde dich an, um fortzufahren.',
  ...
  license: {
    tip: 'Bevor du mit AgentFlow Community Edition beginnst, lies die',
    link: 'Open-Source-Lizenz',
  },
  join: 'Beitreten',
  joinTipStart: 'Lade dich ein, dem',
  joinTipEnd: 'Team auf AgentFlow beizutreten',
  invalid: 'Der Link ist abgelaufen',
  explore: 'AgentFlow erkunden',
  ...
  resetPasswordDesc: 'Geben Sie die E-Mail-Adresse ein, mit der Sie sich bei AgentFlow angemeldet haben, und wir senden Ihnen eine E-Mail zum Zurücksetzen des Passworts.',
