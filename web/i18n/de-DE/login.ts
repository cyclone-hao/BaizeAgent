const translation = {
  ...
  welcome: 'Willkommen bei 白泽智能体平台, bitte melde dich an, um fortzufahren.',
  ...
  license: {
    tip: 'Bevor du mit 白泽智能体平台 Community Edition beginnst, lies die',
    link: 'Open-Source-Lizenz',
  },
  join: 'Beitreten',
  joinTipStart: 'Lade dich ein, dem',
  joinTipEnd: 'Team auf 白泽智能体平台 beizutreten',
  invalid: 'Der Link ist abgelaufen',
  explore: '白泽智能体平台 erkunden',
  ...
  resetPasswordDesc: 'Geben Sie die E-Mail-Adresse ein, mit der Sie sich bei 白泽智能体平台 angemeldet haben, und wir senden Ihnen eine E-Mail zum Zurücksetzen des Passworts.',
  ...
  licenseLostTip: 'Fehler beim Verbinden des 白泽智能体平台-Lizenzservers. Wenden Sie sich an Ihren Administrator, um 白泽智能体平台 weiterhin zu verwenden.',
  licenseInactive: 'Lizenz inaktiv',
  licenseInactiveTip: 'Die 白泽智能体平台 Enterprise-Lizenz für Ihren Arbeitsbereich ist inaktiv. Wenden Sie sich an Ihren Administrator, um 白泽智能体平台 weiterhin zu verwenden.',
  licenseExpiredTip: 'Die 白泽智能体平台 Enterprise-Lizenz für Ihren Arbeitsbereich ist abgelaufen. Wenden Sie sich an Ihren Administrator, um 白泽智能体平台 weiterhin zu verwenden.',
