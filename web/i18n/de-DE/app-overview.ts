const translation = {
  ...
  apiKeyInfo: {
    ...
    tryCloud: 'Oder probieren Sie die Cloud-Version von AgentFlow mit kostenlosem Angebot aus',
  },
  overview: {
    title: 'Übersicht',
    appInfo: {
      ...
      settings: {
        ...
        more: {
          ...
          privacyPolicyTip: 'Hilft Besuchern zu verstehen, welche Daten die Anwendung sammelt, siehe AgentFlows <privacyPolicyLink>Datenschutzrichtlinie</privacyPolicyLink>.',
      ...
      embedded: {
        ...
        chromePlugin: 'Installieren Sie die AgentFlow Chatbot Chrome-Erweiterung',
        copied: 'Kopiert',
        copy: 'Kopieren',
      },
      qrcode: {
