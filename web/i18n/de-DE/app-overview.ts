const translation = {
  ...
  apiKeyInfo: {
    ...
    tryCloud: 'Oder probieren Sie die Cloud-Version von 白泽智能体平台 mit kostenlosem Angebot aus',
  },
  overview: {
    title: 'Übersicht',
    appInfo: {
      ...
      settings: {
        ...
        more: {
          ...
          privacyPolicyTip: 'Hilft Besuchern zu verstehen, welche Daten die Anwendung sammelt, siehe 白泽智能体平台s <privacyPolicyLink>Datenschutzrichtlinie</privacyPolicyLink>.',
      ...
      embedded: {
        ...
        chromePlugin: 'Installieren Sie die 白泽智能体平台 Chatbot Chrome-Erweiterung',
        copied: 'Kopiert',
        copy: 'Kopieren',
      },
      qrcode: {
