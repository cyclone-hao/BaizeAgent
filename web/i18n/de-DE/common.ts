const translation = {
  ...
  members: {
    ...
    invitationSentTip: 'Einladung gesendet, und sie können sich bei AgentFlow anmelden, um auf Ihre Teamdaten zuzugreifen.',
  ...
  provider: {
    ...
    openaiHosted: {
      ...
      desc: 'Der OpenAI-Hostingdienst von AgentFlow ermöglicht es Ihnen, Modelle wie GPT-3.5 zu verwenden. Bevor Ihr Probe-Kontingent aufgebraucht ist, müssen Sie andere Modellanbieter einrichten.',
  ...
  about: {
    ...
    nowAvailable: 'AgentFlow {{version}} ist jetzt verfügbar.',
    latestAvailable: 'AgentFlow {{version}} ist die neueste verfügbare Version.',
  },
  appMenus: {
    overview: 'Übersicht',
