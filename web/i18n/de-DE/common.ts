const translation = {
  ...
  account: {
    ...
    langGeniusAccount: '白泽智能体平台-Konto',
    langGeniusAccountTip: 'Ihr 白泽智能体平台-Konto und zugehörige Benutzerdaten.',
  ...
  members: {
    ...
    invitationSentTip: 'Einladung gesendet, und sie können sich bei 白泽智能体平台 anmelden, um auf Ihre Teamdaten zuzugreifen.',
  ...
  provider: {
    ...
    openaiHosted: {
      ...
      desc: 'Der OpenAI-Hostingdienst von 白泽智能体平台 ermöglicht es Ihnen, Modelle wie GPT-3.5 zu verwenden. Bevor Ihr Probe-Kontingent aufgebraucht ist, müssen Sie andere Modellanbieter einrichten.',
  ...
  apiBasedExtension: {
    title: 'API-Erweiterungen bieten zentralisiertes API-Management und vereinfachen die Konfiguration für eine einfache Verwendung in 白泽智能体平台s Anwendungen.',
  ...
  about: {
    ...
    nowAvailable: '白泽智能体平台 {{version}} ist jetzt verfügbar.',
    latestAvailable: '白泽智能体平台 {{version}} ist die neueste verfügbare Version.',
  },
  appMenus: {
    overview: 'Übersicht',
