const translation = {
  list: {
    title: 'Dokumente',
    desc: 'Alle Dateien des Wissens werden hier angezeigt, und das gesamte Wissen kann mit 白泽智能体平台-Zitaten verknüpft oder über das Chat-Plugin indiziert werden.',
    ...
    empty: {
      ...
      sync: {
        tip: '白泽智能体平台 wird periodisch Dateien von Ihrem Notion herunterladen und die Verarbeitung abschließen.',
      },
    },
    delete: {
