const translation = {
  list: {
    title: 'Dokumente',
    desc: 'Alle Dateien des Wissens werden hier angezeigt, und das gesamte Wissen kann mit AgentFlow-Zitaten verknüpft oder über das Chat-Plugin indiziert werden.',
