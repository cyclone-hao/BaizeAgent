const translation = {
  ...
  intro1: 'Das Wissen kann in die 白泽智能体平台-Anwendung ',
  intro2: 'als Kontext',
  intro3: ',',
  intro4: 'oder es ',
  ...
  externalAPIPanelDescription: 'Die API für externes Wissen wird verwendet, um eine Verbindung zu einer Wissensdatenbank außerhalb von 白泽智能体平台 herzustellen und Wissen aus dieser Wissensdatenbank abzurufen.',
