const translation = {
  tips: {
    ...
    notLoggedIn: 'Diese App möchte auf Ihr AgentFlow Cloud-Konto zugreifen',
    loggedIn: 'Diese App möchte auf die folgenden Informationen aus Ihrem AgentFlow Cloud-Konto zugreifen.',
