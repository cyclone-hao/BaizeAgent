const translation = {
  tips: {
    ...
    notLoggedIn: 'Diese App möchte auf Ihr 白泽智能体平台 Cloud-Konto zugreifen',
    loggedIn: 'Diese App möchte auf die folgenden Informationen aus Ihrem 白泽智能体平台 Cloud-Konto zugreifen.',
