const translation = {
  toVerifiedTip: {
    ...
    end: 'für den 白泽智能体平台 Professional Plan.',
  ...
  rejectTitle: 'Ihre 白泽智能体平台-Ausbildungsüberprüfung wurde abgelehnt.',
  ...
  rejectContent: 'Leider sind Sie nicht für den Status "Education Verified" berechtigt und können daher den exklusiven 100%-Gutschein für den 白泽智能体平台 Professional Plan nicht erhalten, wenn Sie diese E-Mail-Adresse verwenden.',
  successContent: 'Wir haben einen 100% Rabattgutschein für den 白泽智能体平台 Professional Plan auf Ihr Konto ausgestellt. Der Gutschein ist ein Jahr lang gültig, bitte nutzen Sie ihn innerhalb des Gültigkeitszeitraums.',
  learn: 'Erfahren Sie, wie Sie Ihre Ausbildung überprüfen lassen.',
  emailLabel: 'Ihre aktuelle E-Mail',
  successTitle: 'Sie haben die 白泽智能体平台-Ausbildung verifiziert',
  notice: {
    expired: {
      summary: {
        line1: 'Sie können weiterhin auf 白泽智能体平台 zugreifen und es nutzen.',
