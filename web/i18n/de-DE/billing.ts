const translation = {
  ...
  plansCommon: {
    ...
    ragAPIRequestTooltip: 'Bezieht sich auf die Anzahl der API-Aufrufe, die nur die Wissensdatenbankverarbeitungsfähigkeiten von AgentFlow aufrufen.',
    ...
    cloud: 'Cloud-Dienst',
    apiRateLimitTooltip: 'Die API-Datenbeschränkung gilt für alle Anfragen, die über die AgentFlow-API gemacht werden, einschließlich Textgenerierung, Chat-Konversationen, Workflow-Ausführungen und Dokumentenverarbeitung.',
    getStarted: 'Loslegen',
  ...
  plans: {
    ...
    enterprise: {
      ...
      features: [
        ...
        'SSO (Single Sign-On)',
        'Vereinbarte SLAs mit AgentFlow-Partnern',
        'Erweiterte Sicherheitsfunktionen und Kontrollen',
        'Offizielle Updates und Wartung durch AgentFlow',
    ...
    community: {
      ...
      features: [
        ...
        'Entspricht der AgentFlow Open-Source-Lizenz',
      ],
    },
    premium: {
