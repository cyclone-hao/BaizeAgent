const translation = {
  ...
  plansCommon: {
    ...
    ragAPIRequestTooltip: 'Bezieht sich auf die Anzahl der API-Aufrufe, die nur die Wissensdatenbankverarbeitungsfähigkeiten von 白泽智能体平台 aufrufen.',
    ...
    cloud: 'Cloud-Dienst',
    apiRateLimitTooltip: 'Die API-Datenbeschränkung gilt für alle Anfragen, die über die 白泽智能体平台-API gemacht werden, einschließlich Textgenerierung, Chat-Konversationen, Workflow-Ausführungen und Dokumentenverarbeitung.',
    getStarted: 'Loslegen',
  ...
  plans: {
    ...
    enterprise: {
      ...
      features: [
        ...
        'SSO (Single Sign-On)',
        'Vereinbarte SLAs mit 白泽智能体平台-Partnern',
        'Erweiterte Sicherheitsfunktionen und Kontrollen',
        'Offizielle Updates und Wartung durch 白泽智能体平台',
    ...
    community: {
      ...
      features: [
        ...
        'Entspricht der 白泽智能体平台 Open-Source-Lizenz',
      ],
    },
    premium: {
