const translation = {
  ...
  account: {
    ...
    langGeniusAccount: 'Compte 白泽智能体平台',
    langGeniusAccountTip: 'Votre compte 白泽智能体平台 et les données utilisateur associées.',
  ...
  members: {
    ...
    invitationSentTip: 'Invitation envoyée, et ils peuvent se connecter à 白泽智能体平台 pour accéder aux données de votre équipe.',
  ...
  provider: {
    ...
    openaiHosted: {
      ...
      desc: 'Le service d\'hébergement OpenAI fourni par 白泽智能体平台 vous permet d\'utiliser des modèles tels que GPT-3.5. Avant que votre quota d\'essai ne soit épuisé, vous devez configurer d\'autres fournisseurs de modèles.',
  ...
  apiBasedExtension: {
    title: 'Les extensions API fournissent une gestion centralisée des API, simplifiant la configuration pour une utilisation facile à travers les applications de 白泽智能体平台.',
  ...
  about: {
    ...
    nowAvailable: '白泽智能体平台 {{version}} est maintenant disponible.',
    latestAvailable: '白泽智能体平台 {{version}} est la dernière version disponible.',
  },
  appMenus: {
