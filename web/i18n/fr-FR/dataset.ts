const translation = {
  ...
  intro1: 'La Connaissance peut être intégrée dans l\'application 白泽智能体平台',
  ...
  externalAPIPanelDescription: 'L’API de connaissances externe est utilisée pour se connecter à une base de connaissances en dehors de 白泽智能体平台 et récupérer des connaissances de cette base de connaissances.',
