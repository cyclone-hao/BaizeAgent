const translation = {
  ...
  apiKeyInfo: {
    ...
    tryCloud: 'Ou essayez la version cloud de AgentFlow avec un devis gratuit',
  },
  overview: {
    title: 'Aperçu',
    appInfo: {
      ...
      settings: {
        ...
        more: {
          ...
          privacyPolicyTip: 'Aide les visiteurs à comprendre les données collectées par l\'application, voir la <privacyPolicyLink>Politique de confidentialité</privacyPolicyLink> de AgentFlow.',
      ...
      embedded: {
        ...
        chromePlugin: 'Installer l\'extension Chrome AgentFlow Chatbot',
        copied: 'Copié',
        copy: 'Copier',
      },
      qrcode: {
