const translation = {
  ...
  apiKeyInfo: {
    ...
    tryCloud: 'Ou essayez la version cloud de 白泽智能体平台 avec un devis gratuit',
  },
  overview: {
    title: 'Aperçu',
    appInfo: {
      ...
      settings: {
        ...
        more: {
          ...
          privacyPolicyTip: 'Aide les visiteurs à comprendre les données collectées par l\'application, voir la <privacyPolicyLink>Politique de confidentialité</privacyPolicyLink> de 白泽智能体平台.',
      ...
      embedded: {
        ...
        chromePlugin: 'Installer l\'extension Chrome 白泽智能体平台 Chatbot',
        copied: 'Copié',
        copy: 'Copier',
      },
      qrcode: {
      ...
      customize: {
        ...
        way1: {
          ...
          step1Operation: 'Client-Web-白泽智能体平台',
