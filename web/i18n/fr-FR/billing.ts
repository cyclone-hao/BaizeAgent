const translation = {
  ...
  plansCommon: {
    ...
    ragAPIRequestTooltip: 'Fait référence au nombre d\'appels API invoquant uniquement les capacités de traitement de la base de connaissances de AgentFlow.',
    ...
    apiRateLimitTooltip: 'La limite de taux de l\'API s\'applique à toutes les demandes effectuées via l\'API AgentFlow, y compris la génération de texte, les conversations de chat, les exécutions de flux de travail et le traitement de documents.',
