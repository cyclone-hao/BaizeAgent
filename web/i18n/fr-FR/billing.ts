const translation = {
  ...
  plansCommon: {
    ...
    ragAPIRequestTooltip: 'Fait référence au nombre d\'appels API invoquant uniquement les capacités de traitement de la base de connaissances de 白泽智能体平台.',
    ...
    apiRateLimitTooltip: 'La limite de taux de l\'API s\'applique à toutes les demandes effectuées via l\'API 白泽智能体平台, y compris la génération de texte, les conversations de chat, les exécutions de flux de travail et le traitement de documents.',
  ...
  plans: {
    ...
    enterprise: {
      ...
      features: {
        ...
        5: 'SLA négociés par les partenaires 白泽智能体平台',
        8: 'Assistance technique professionnelle',
        7: 'Mises à jour et maintenance par 白泽智能体平台 officiellement',
    ...
    community: {
      features: {
        ...
        2: 'Conforme à la licence Open Source 白泽智能体平台',
      },
      name: 'Communauté',
