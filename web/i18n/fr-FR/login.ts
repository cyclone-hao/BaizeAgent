const translation = {
  ...
  welcome: 'Bienvenue sur AgentFlow, veuillez vous connecter pour continuer.',
  ...
  license: {
    tip: 'Avant de commencer AgentFlow Community Edition, lisez le GitHub',
    link: 'Licence Open-source',
  },
  join: 'Rejoindre',
  joinTipStart: 'Je vous invite à rejoindre',
  joinTipEnd: 'équipe sur AgentFlow',
  invalid: 'Le lien a expiré',
  explore: 'Explorez AgentFlow',
  ...
  resetPasswordDesc: 'Tapez l’adresse e-mail que vous avez utilisée pour vous inscrire sur AgentFlow et nous vous enverrons un e-mail de réinitialisation de mot de passe.',
  usePassword: 'Utiliser le mot de passe',
  licenseInactiveTip: 'La licence AgentFlow Enterprise de votre espace de travail est inactive. Veuillez contacter votre administrateur pour continuer à utiliser AgentFlow.',
  licenseLostTip: 'Échec de la connexion au serveur de licences AgentFlow. Veuillez contacter votre administrateur pour continuer à utiliser AgentFlow.',
  licenseExpired: 'Licence expirée',
  licenseLost: 'Licence perdue',
  licenseExpiredTip: 'La licence AgentFlow Enterprise de votre espace de travail a expiré. Veuillez contacter votre administrateur pour continuer à utiliser AgentFlow.',
