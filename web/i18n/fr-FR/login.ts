const translation = {
  ...
  welcome: 'Bienvenue sur 白泽智能体平台, veuillez vous connecter pour continuer.',
  ...
  license: {
    tip: 'Avant de commencer 白泽智能体平台 Community Edition, lisez le GitHub',
    link: 'Licence Open-source',
  },
  join: 'Rejoindre',
  joinTipStart: 'Je vous invite à rejoindre',
  joinTipEnd: 'équipe sur 白泽智能体平台',
  invalid: 'Le lien a expiré',
  explore: 'Explorez 白泽智能体平台',
  ...
  resetPasswordDesc: 'Tapez l’adresse e-mail que vous avez utilisée pour vous inscrire sur 白泽智能体平台 et nous vous enverrons un e-mail de réinitialisation de mot de passe.',
  usePassword: 'Utiliser le mot de passe',
  licenseInactiveTip: 'La licence 白泽智能体平台 Enterprise de votre espace de travail est inactive. Veuillez contacter votre administrateur pour continuer à utiliser 白泽智能体平台.',
  licenseLostTip: 'Échec de la connexion au serveur de licences 白泽智能体平台. Veuillez contacter votre administrateur pour continuer à utiliser 白泽智能体平台.',
  licenseExpired: 'Licence expirée',
  licenseLost: 'Licence perdue',
  licenseExpiredTip: 'La licence 白泽智能体平台 Enterprise de votre espace de travail a expiré. Veuillez contacter votre administrateur pour continuer à utiliser 白泽智能体平台.',
