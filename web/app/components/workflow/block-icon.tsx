...
const ICON_CONTAINER_BG_COLOR_MAP: Record<string, string> = {
  ...
  [BlockEnum.Code]: 'bg-util-colors-blue-brand-blue-brand-500',
  ...
  [BlockEnum.TemplateTransform]: 'bg-util-colors-blue-brand-blue-brand-500',
  [BlockEnum.VariableAssigner]: 'bg-util-colors-blue-brand-blue-brand-500',
  [BlockEnum.VariableAggregator]: 'bg-util-colors-blue-brand-blue-brand-500',
  [BlockEnum.Tool]: 'bg-util-colors-blue-brand-blue-brand-500',
  [BlockEnum.Assigner]: 'bg-util-colors-blue-brand-blue-brand-500',
  [BlockEnum.ParameterExtractor]: 'bg-util-colors-blue-brand-blue-brand-500',
  [BlockEnum.DocExtractor]: 'bg-util-colors-green-green-500',
  [BlockEnum.ListFilter]: 'bg-util-colors-cyan-cyan-500',
  [BlockEnum.Agent]: 'bg-util-colors-violet-violet-500',
