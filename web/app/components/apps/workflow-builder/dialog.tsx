...
import { RiArrowDownSLine, RiCloseLine, RiLoader2Line, RiRefreshLine, RiSendPlaneFill, RiSparklingFill } from '@remixicon/react'
...
const WorkflowBuilderDialog: React.FC<WorkflowBuilderDialogProps> = ({
  show,
  onClose,
  onSuccess,
}) => {
              ...
              {messages.length === 0 ? (
                <div className="flex h-full flex-col items-center justify-center text-center">
                  ...
                  <p className="max-w-md text-sm text-text-secondary">
                    描述您想要创建的工作流，AI 将帮助您设计并生成完整的工作流配置。
                  </p>
